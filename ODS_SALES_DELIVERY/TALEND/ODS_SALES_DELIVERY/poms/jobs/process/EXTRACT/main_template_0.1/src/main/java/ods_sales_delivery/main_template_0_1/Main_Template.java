...
package ods_sales_delivery.main_template_0_1;
...
public String getTALEND_CONF_FileSeparator(){
	...
	private final String projectName = "ODS_SALES_DELIVERY";
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_ODS_SALES_DELIVERY_Main_Template = new byte[0];
    static byte[] commonByteArray_ODS_SALES_DELIVERY_Main_Template = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_SALES_DELIVERY_Main_Template.length) {
				if(length < 1024 && commonByteArray_ODS_SALES_DELIVERY_Main_Template.length == 0) {
   					commonByteArray_ODS_SALES_DELIVERY_Main_Template = new byte[1024];
				} else {
   					commonByteArray_ODS_SALES_DELIVERY_Main_Template = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_SALES_DELIVERY_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_DELIVERY_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_SALES_DELIVERY_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_DELIVERY_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_SALES_DELIVERY_Main_Template) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ods_sales_delivery.load_context_0_1.Load_context childJob_tRunJob_1 = new ods_sales_delivery.load_context_0_1.Load_context();
	    // pass DataSources
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public String loopKey;
			    ...
			    public Integer PO_Key;

				public Integer getPO_Key () {
					return this.PO_Key;
				}
			    ...
			    public java.util.Date THEORICAL_DELIVERY_DATE;

				public java.util.Date getTHEORICAL_DELIVERY_DATE () {
					return this.THEORICAL_DELIVERY_DATE;
				}
				
			    public int PO_LINE_KEY;

				public int getPO_LINE_KEY () {
					return this.PO_LINE_KEY;
				}
				
			    public int CUSTOMER_DELIVERY_NUMBER;

				public int getCUSTOMER_DELIVERY_NUMBER () {
					return this.CUSTOMER_DELIVERY_NUMBER;
				}
				
			    public java.util.Date DELIVERY_CREATION_DATE;

				public java.util.Date getDELIVERY_CREATION_DATE () {
					return this.DELIVERY_CREATION_DATE;
				}
				
			    public java.util.Date DELIVERY_MODIFICATION_DATE;

				public java.util.Date getDELIVERY_MODIFICATION_DATE () {
					return this.DELIVERY_MODIFICATION_DATE;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
							...
							result = prime * result + (int) this.PO_LINE_KEY;
						
							result = prime * result + (int) this.CUSTOMER_DELIVERY_NUMBER;
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						if (this.PO_LINE_KEY != other.PO_LINE_KEY)
							return false;
					
						if (this.CUSTOMER_DELIVERY_NUMBER != other.CUSTOMER_DELIVERY_NUMBER)
							return false;
	...
	public void copyDataTo(row2Struct other) {
		...
		other.ORGANIZATIONLVL3ID = this.ORGANIZATIONLVL3ID;
	            ...
	            other.PO_Key = this.PO_Key;
	            other.RELEASE_ID = this.RELEASE_ID;
	            other.QUANTITY = this.QUANTITY;
	            other.SHIPPING_DATE = this.SHIPPING_DATE;
	            other.THEORICAL_DELIVERY_DATE = this.THEORICAL_DELIVERY_DATE;
	            other.PO_LINE_KEY = this.PO_LINE_KEY;
	            other.CUSTOMER_DELIVERY_NUMBER = this.CUSTOMER_DELIVERY_NUMBER;
	            other.DELIVERY_CREATION_DATE = this.DELIVERY_CREATION_DATE;
	            other.DELIVERY_MODIFICATION_DATE = this.DELIVERY_MODIFICATION_DATE;
		...
		synchronized(commonByteArrayLock_ODS_SALES_DELIVERY_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.MATERIAL_ID = readInteger(dis);
					
						this.CUSTOMER_ID = readInteger(dis);
					
					this.PO_NO = readString(dis);
					
						this.PO_Key = readInteger(dis);
					...
					this.THEORICAL_DELIVERY_DATE = readDate(dis);
					
			        this.PO_LINE_KEY = dis.readInt();
					
			        this.CUSTOMER_DELIVERY_NUMBER = dis.readInt();
					
					this.DELIVERY_CREATION_DATE = readDate(dis);
					
					this.DELIVERY_MODIFICATION_DATE = readDate(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.MATERIAL_ID,dos);
					...
					// java.util.Date
						...
						writeDate(this.THEORICAL_DELIVERY_DATE,dos);
					
					// int
				
		            	dos.writeInt(this.PO_LINE_KEY);
					
					// int
				
		            	dos.writeInt(this.CUSTOMER_DELIVERY_NUMBER);
					
					// java.util.Date
				
						writeDate(this.DELIVERY_CREATION_DATE,dos);
					
					// java.util.Date
				
						writeDate(this.DELIVERY_MODIFICATION_DATE,dos);
    ...
    public String toString() {
		...
		sb.append(",PO_Key="+String.valueOf(PO_Key));
		...
		sb.append(",THEORICAL_DELIVERY_DATE="+String.valueOf(THEORICAL_DELIVERY_DATE));
		sb.append(",PO_LINE_KEY="+String.valueOf(PO_LINE_KEY));
		sb.append(",CUSTOMER_DELIVERY_NUMBER="+String.valueOf(CUSTOMER_DELIVERY_NUMBER));
		sb.append(",DELIVERY_CREATION_DATE="+String.valueOf(DELIVERY_CREATION_DATE));
		sb.append(",DELIVERY_MODIFICATION_DATE="+String.valueOf(DELIVERY_MODIFICATION_DATE));
	    sb.append("]");
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.PO_LINE_KEY, other.PO_LINE_KEY);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.CUSTOMER_DELIVERY_NUMBER, other.CUSTOMER_DELIVERY_NUMBER);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ODS_SALES_DELIVERY_Main_Template = new byte[0];
			    ...
			    public String CustomerDeliveryNumber;

				public String getCustomerDeliveryNumber () {
					return this.CustomerDeliveryNumber;
				}
				
			    public String DeliveryCreationDate;

				public String getDeliveryCreationDate () {
					return this.DeliveryCreationDate;
				}
				
			    public String DeliveryModificationDate;

				public String getDeliveryModificationDate () {
					return this.DeliveryModificationDate;
				}
				
			    public String DeliveryDeletionFlag;

				public String getDeliveryDeletionFlag () {
					return this.DeliveryDeletionFlag;
				}
			    ...
			    public String ShipToPartyCustomer;

				public String getShipToPartyCustomer () {
					return this.ShipToPartyCustomer;
				}
				
			    public String ORGANIZATIONLVL3ID;

				public String getORGANIZATIONLVL3ID () {
					return this.ORGANIZATIONLVL3ID;
				}
			    ...
			    public String RealQuantityInSalesUnit;

				public String getRealQuantityInSalesUnit () {
					return this.RealQuantityInSalesUnit;
				}
			    ...
			    public String RealShippingDate;

				public String getRealShippingDate () {
					return this.RealShippingDate;
				}
				
			    public String TheoriticalDeliveryDate;

				public String getTheoriticalDeliveryDate () {
					return this.TheoriticalDeliveryDate;
				}
			    ...
			    public String PART_UNIQUE;

				public String getPART_UNIQUE () {
					return this.PART_UNIQUE;
				}
				
			    public String CUSTOMER_UNIQUE;

				public String getCUSTOMER_UNIQUE () {
					return this.CUSTOMER_UNIQUE;
				}
			    ...
			    public Integer Release_Key;

				public Integer getRelease_Key () {
					return this.Release_Key;
				}
				
			    public Integer PO_Line_Key;

				public Integer getPO_Line_Key () {
					return this.PO_Line_Key;
				}
				
			    public Integer Shipper_Key;

				public Integer getShipper_Key () {
					return this.Shipper_Key;
				}
				
			    public Integer ORGANIZATIONLVL3ID_INT;

				public Integer getORGANIZATIONLVL3ID_INT () {
					return this.ORGANIZATIONLVL3ID_INT;
				}
			    ...
			    public String DeliveryCreationDate_NOTEXT;

				public String getDeliveryCreationDate_NOTEXT () {
					return this.DeliveryCreationDate_NOTEXT;
				}
				
			    public String DeliveryModificationDate_NOTEXT;

				public String getDeliveryModificationDate_NOTEXT () {
					return this.DeliveryModificationDate_NOTEXT;
				}
				
			    public String RealShippingDate_NOTEXT;

				public String getRealShippingDate_NOTEXT () {
					return this.RealShippingDate_NOTEXT;
				}
				
			    public String TheoriticalDeliveryDate_NOTEXT;

				public String getTheoriticalDeliveryDate_NOTEXT () {
					return this.TheoriticalDeliveryDate_NOTEXT;
				}
		...
		synchronized(commonByteArrayLock_ODS_SALES_DELIVERY_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.DeliveryItem = readString(dis);
					
					this.CustomerDeliveryNumber = readString(dis);
					
					this.DeliveryCreationDate = readString(dis);
					
					this.DeliveryModificationDate = readString(dis);
					
					this.DeliveryDeletionFlag = readString(dis);
					
					this.SalesDocumentNumber = readString(dis);
					
					this.SalesDocumentItem = readString(dis);
					
					this.Material = readString(dis);
					
					this.OrderingCustomer = readString(dis);
					
					this.ShipToPartyCustomer = readString(dis);
					
					this.ORGANIZATIONLVL3ID = readString(dis);
					
					this.SourceSystem = readString(dis);
					
					this.RealQuantityInSalesUnit = readString(dis);
					
					this.SalesUnit = readString(dis);
					
					this.RealShippingDate = readString(dis);
					
					this.TheoriticalDeliveryDate = readString(dis);
					
					this.PO_NO = readString(dis);
					
					this.PART_UNIQUE = readString(dis);
					
					this.CUSTOMER_UNIQUE = readString(dis);
					
						this.PO_Key = readInteger(dis);
					
						this.Release_Key = readInteger(dis);
					
						this.PO_Line_Key = readInteger(dis);
					
						this.Shipper_Key = readInteger(dis);
					
						this.ORGANIZATIONLVL3ID_INT = readInteger(dis);
					...
					this.DeliveryCreationDate_NOTEXT = readString(dis);
					
					this.DeliveryModificationDate_NOTEXT = readString(dis);
					
					this.RealShippingDate_NOTEXT = readString(dis);
					
					this.TheoriticalDeliveryDate_NOTEXT = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.DeliveryItem,dos);
					
					// String
				
						writeString(this.CustomerDeliveryNumber,dos);
					
					// String
				
						writeString(this.DeliveryCreationDate,dos);
					
					// String
				
						writeString(this.DeliveryModificationDate,dos);
					
					// String
				
						writeString(this.DeliveryDeletionFlag,dos);
					
					// String
				
						writeString(this.SalesDocumentNumber,dos);
					
					// String
				
						writeString(this.SalesDocumentItem,dos);
					...
					// String
						...
						writeString(this.OrderingCustomer,dos);
					
					// String
				
						writeString(this.ShipToPartyCustomer,dos);
					
					// String
				
						writeString(this.ORGANIZATIONLVL3ID,dos);
					...
					// String
						...
						writeString(this.RealQuantityInSalesUnit,dos);
					
					// String
				
						writeString(this.SalesUnit,dos);
					
					// String
				
						writeString(this.RealShippingDate,dos);
					
					// String
				
						writeString(this.TheoriticalDeliveryDate,dos);
					...
					// String
						...
						writeString(this.PART_UNIQUE,dos);
					
					// String
				
						writeString(this.CUSTOMER_UNIQUE,dos);
					...
					// Integer
						...
						writeInteger(this.Release_Key,dos);
					
					// Integer
				
						writeInteger(this.PO_Line_Key,dos);
					
					// Integer
				
						writeInteger(this.Shipper_Key,dos);
					
					// Integer
				
						writeInteger(this.ORGANIZATIONLVL3ID_INT,dos);
					...
					// String
						...
						writeString(this.DeliveryCreationDate_NOTEXT,dos);
					
					// String
				
						writeString(this.DeliveryModificationDate_NOTEXT,dos);
					
					// String
				
						writeString(this.RealShippingDate_NOTEXT,dos);
					
					// String
				
						writeString(this.TheoriticalDeliveryDate_NOTEXT,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("DeliveryItem="+DeliveryItem);
		sb.append(",CustomerDeliveryNumber="+CustomerDeliveryNumber);
		sb.append(",DeliveryCreationDate="+DeliveryCreationDate);
		sb.append(",DeliveryModificationDate="+DeliveryModificationDate);
		sb.append(",DeliveryDeletionFlag="+DeliveryDeletionFlag);
		sb.append(",SalesDocumentNumber="+SalesDocumentNumber);
		sb.append(",SalesDocumentItem="+SalesDocumentItem);
		sb.append(",Material="+Material);
		sb.append(",OrderingCustomer="+OrderingCustomer);
		sb.append(",ShipToPartyCustomer="+ShipToPartyCustomer);
		sb.append(",ORGANIZATIONLVL3ID="+ORGANIZATIONLVL3ID);
		sb.append(",SourceSystem="+SourceSystem);
		sb.append(",RealQuantityInSalesUnit="+RealQuantityInSalesUnit);
		sb.append(",SalesUnit="+SalesUnit);
		sb.append(",RealShippingDate="+RealShippingDate);
		sb.append(",TheoriticalDeliveryDate="+TheoriticalDeliveryDate);
		sb.append(",PO_NO="+PO_NO);
		sb.append(",PART_UNIQUE="+PART_UNIQUE);
		sb.append(",CUSTOMER_UNIQUE="+CUSTOMER_UNIQUE);
		sb.append(",PO_Key="+String.valueOf(PO_Key));
		sb.append(",Release_Key="+String.valueOf(Release_Key));
		sb.append(",PO_Line_Key="+String.valueOf(PO_Line_Key));
		sb.append(",Shipper_Key="+String.valueOf(Shipper_Key));
		sb.append(",ORGANIZATIONLVL3ID_INT="+String.valueOf(ORGANIZATIONLVL3ID_INT));
		sb.append(",Quantity="+String.valueOf(Quantity));
		sb.append(",DeliveryCreationDate_NOTEXT="+DeliveryCreationDate_NOTEXT);
		sb.append(",DeliveryModificationDate_NOTEXT="+DeliveryModificationDate_NOTEXT);
		sb.append(",RealShippingDate_NOTEXT="+RealShippingDate_NOTEXT);
		sb.append(",TheoriticalDeliveryDate_NOTEXT="+TheoriticalDeliveryDate_NOTEXT);
	    sb.append("]");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "ODS_SALES_DELIVERY";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "ODS_SALES_DELIVERY";
}
	int count_tDBOutput_1=0;

        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [PO_LINE_KEY] = ? AND [CUSTOMER_DELIVERY_NUMBER] = ?");
        resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([ORGANIZATIONLVL3ID],[MATERIAL_ID],[CUSTOMER_ID],[PO_NO],[PO_Key],[RELEASE_ID],[QUANTITY],[SHIPPING_DATE],[THEORICAL_DELIVERY_DATE],[PO_LINE_KEY],[CUSTOMER_DELIVERY_NUMBER],[DELIVERY_CREATION_DATE],[DELIVERY_MODIFICATION_DATE]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [ORGANIZATIONLVL3ID] = ?,[MATERIAL_ID] = ?,[CUSTOMER_ID] = ?,[PO_NO] = ?,[PO_Key] = ?,[RELEASE_ID] = ?,[QUANTITY] = ?,[SHIPPING_DATE] = ?,[THEORICAL_DELIVERY_DATE] = ?,[DELIVERY_CREATION_DATE] = ?,[DELIVERY_MODIFICATION_DATE] = ? WHERE [PO_LINE_KEY] = ? AND [CUSTOMER_DELIVERY_NUMBER] = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nEXEC ('sproc278344_10639364_1891848') AT [PLEX]\n";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.DeliveryItem = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.DeliveryItem = tmpContent_tDBInput_1;
                }
            } else {
                row1.DeliveryItem = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 2) {
								row1.CustomerDeliveryNumber = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(2);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.CustomerDeliveryNumber = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.CustomerDeliveryNumber = tmpContent_tDBInput_1;
                }
            } else {
                row1.CustomerDeliveryNumber = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.DeliveryCreationDate = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(3);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.DeliveryCreationDate = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.DeliveryCreationDate = tmpContent_tDBInput_1;
                }
            } else {
                row1.DeliveryCreationDate = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.DeliveryModificationDate = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(4);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.DeliveryModificationDate = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.DeliveryModificationDate = tmpContent_tDBInput_1;
                }
            } else {
                row1.DeliveryModificationDate = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.DeliveryDeletionFlag = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(5);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.DeliveryDeletionFlag = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.DeliveryDeletionFlag = tmpContent_tDBInput_1;
                }
            } else {
                row1.DeliveryDeletionFlag = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.SalesDocumentNumber = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(6);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.SalesDocumentNumber = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.SalesDocumentNumber = tmpContent_tDBInput_1;
                }
            } else {
                row1.SalesDocumentNumber = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.SalesDocumentItem = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.SalesDocumentItem = tmpContent_tDBInput_1;
                }
            } else {
                row1.SalesDocumentItem = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Material = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Material = tmpContent_tDBInput_1;
                }
            } else {
                row1.Material = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(9).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.OrderingCustomer = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.OrderingCustomer = tmpContent_tDBInput_1;
                }
            } else {
                row1.OrderingCustomer = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.ShipToPartyCustomer = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.ShipToPartyCustomer = tmpContent_tDBInput_1;
                }
            } else {
                row1.ShipToPartyCustomer = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(11).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.ORGANIZATIONLVL3ID = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.ORGANIZATIONLVL3ID = tmpContent_tDBInput_1;
                }
            } else {
                row1.ORGANIZATIONLVL3ID = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(12).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.SourceSystem = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.SourceSystem = tmpContent_tDBInput_1;
                }
            } else {
                row1.SourceSystem = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.RealQuantityInSalesUnit = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(13).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.RealQuantityInSalesUnit = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.RealQuantityInSalesUnit = tmpContent_tDBInput_1;
                }
            } else {
                row1.RealQuantityInSalesUnit = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(14).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.SalesUnit = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.SalesUnit = tmpContent_tDBInput_1;
                }
            } else {
                row1.SalesUnit = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(15).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.RealShippingDate = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.RealShippingDate = tmpContent_tDBInput_1;
                }
            } else {
                row1.RealShippingDate = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.TheoriticalDeliveryDate = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(16).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.TheoriticalDeliveryDate = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.TheoriticalDeliveryDate = tmpContent_tDBInput_1;
                }
            } else {
                row1.TheoriticalDeliveryDate = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(17).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.PO_NO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.PO_NO = tmpContent_tDBInput_1;
                }
            } else {
                row1.PO_NO = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(18).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.PART_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.PART_UNIQUE = tmpContent_tDBInput_1;
                }
            } else {
                row1.PART_UNIQUE = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(19).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.CUSTOMER_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.CUSTOMER_UNIQUE = tmpContent_tDBInput_1;
                }
            } else {
                row1.CUSTOMER_UNIQUE = null;
            }
            ...
            row1.PO_Key = rs_tDBInput_1.getInt(20);
            if(rs_tDBInput_1.wasNull()){
                    row1.PO_Key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 21) {
								row1.Release_Key = null;
							} else {
		                          
            row1.Release_Key = rs_tDBInput_1.getInt(21);
            if(rs_tDBInput_1.wasNull()){
                    row1.Release_Key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 22) {
								row1.PO_Line_Key = null;
							} else {
		                          
            row1.PO_Line_Key = rs_tDBInput_1.getInt(22);
            if(rs_tDBInput_1.wasNull()){
                    row1.PO_Line_Key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 23) {
								row1.Shipper_Key = null;
							} else {
		                          
            row1.Shipper_Key = rs_tDBInput_1.getInt(23);
            if(rs_tDBInput_1.wasNull()){
                    row1.Shipper_Key = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 24) {
								row1.ORGANIZATIONLVL3ID_INT = null;
							} else {
		                          
            row1.ORGANIZATIONLVL3ID_INT = rs_tDBInput_1.getInt(24);
            if(rs_tDBInput_1.wasNull()){
                    row1.ORGANIZATIONLVL3ID_INT = null;
            }
		                    }
            ...
            row1.Quantity = rs_tDBInput_1.getDouble(25);
            if(rs_tDBInput_1.wasNull()){
                    row1.Quantity = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 26) {
								row1.DeliveryCreationDate_NOTEXT = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(26).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.DeliveryCreationDate_NOTEXT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.DeliveryCreationDate_NOTEXT = tmpContent_tDBInput_1;
                }
            } else {
                row1.DeliveryCreationDate_NOTEXT = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 27) {
								row1.DeliveryModificationDate_NOTEXT = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(27).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.DeliveryModificationDate_NOTEXT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.DeliveryModificationDate_NOTEXT = tmpContent_tDBInput_1;
                }
            } else {
                row1.DeliveryModificationDate_NOTEXT = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 28) {
								row1.RealShippingDate_NOTEXT = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(28).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.RealShippingDate_NOTEXT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.RealShippingDate_NOTEXT = tmpContent_tDBInput_1;
                }
            } else {
                row1.RealShippingDate_NOTEXT = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 29) {
								row1.TheoriticalDeliveryDate_NOTEXT = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(29).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.TheoriticalDeliveryDate_NOTEXT = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.TheoriticalDeliveryDate_NOTEXT = tmpContent_tDBInput_1;
                }
            } else {
                row1.TheoriticalDeliveryDate_NOTEXT = null;
            }
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.MATERIAL_NO_UNIQUE = row1.PART_UNIQUE ;
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row4HashKey.CUSTOMER_CODE_UNIQUE = row1.CUSTOMER_UNIQUE ;
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.CUSTOMER_CODE_UNIQUE = '" + row4HashKey.CUSTOMER_CODE_UNIQUE + "'");
								} // G 071
...
// # Output table : 'Insert'
Insert_tmp.ORGANIZATIONLVL3ID = row1.ORGANIZATIONLVL3ID_INT ;
Insert_tmp.MATERIAL_ID = row3.MATERIAL_ID ;
Insert_tmp.CUSTOMER_ID = row4.CUSTOMER_ID ;
Insert_tmp.PO_NO = row1.PO_NO ;
Insert_tmp.PO_Key = row1.PO_Key ;
Insert_tmp.RELEASE_ID = row1.Release_Key ;
Insert_tmp.QUANTITY = row1.Quantity ;
Insert_tmp.SHIPPING_DATE = TalendDate.parseDate("yyyy-MM-dd",row1.RealShippingDate_NOTEXT) ;
Insert_tmp.THEORICAL_DELIVERY_DATE = TalendDate.parseDate("yyyy-MM-dd",row1.TheoriticalDeliveryDate_NOTEXT);
Insert_tmp.PO_LINE_KEY = row1.PO_Line_Key ;
Insert_tmp.CUSTOMER_DELIVERY_NUMBER = row1.Shipper_Key ;
Insert_tmp.DELIVERY_CREATION_DATE = TalendDate.parseDate("yyyy-MM-dd",row1.DeliveryCreationDate_NOTEXT );
Insert_tmp.DELIVERY_MODIFICATION_DATE = TalendDate.parseDate("yyyy-MM-dd",row1.DeliveryModificationDate_NOTEXT );
Insert = Insert_tmp;
// ###############################
...
if(Insert != null) { 
	...
	currentComponent="tDBOutput_1";
        ...
        whetherReject_tDBOutput_1 = false;
                    ...
                    pstmt_tDBOutput_1.setInt(1, Insert.PO_LINE_KEY);



                    pstmt_tDBOutput_1.setInt(2, Insert.CUSTOMER_DELIVERY_NUMBER);
...
} else {pstmtUpdate_tDBOutput_1.setInt(1, Insert.ORGANIZATIONLVL3ID);
}

                        if(Insert.MATERIAL_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(2, Insert.MATERIAL_ID);
}

                        if(Insert.CUSTOMER_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(3, Insert.CUSTOMER_ID);
}

                        if(Insert.PO_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, Insert.PO_NO);
}

                        if(Insert.PO_Key == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(5, Insert.PO_Key);
}

                        if(Insert.RELEASE_ID == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(6, Insert.RELEASE_ID);
}

                        if(Insert.QUANTITY == null) {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_1.setDouble(7, Insert.QUANTITY);
}

                        if(Insert.SHIPPING_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(Insert.SHIPPING_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.TIMESTAMP);
}

                        if(Insert.THEORICAL_DELIVERY_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(Insert.THEORICAL_DELIVERY_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.TIMESTAMP);
}

                        if(Insert.DELIVERY_CREATION_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(10, new java.sql.Timestamp(Insert.DELIVERY_CREATION_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.TIMESTAMP);
}

                        if(Insert.DELIVERY_MODIFICATION_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(11, new java.sql.Timestamp(Insert.DELIVERY_MODIFICATION_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(11, java.sql.Types.TIMESTAMP);
                        ...
                        pstmtUpdate_tDBOutput_1.setInt(12 + count_tDBOutput_1, Insert.PO_LINE_KEY);


	                    

                        pstmtUpdate_tDBOutput_1.setInt(13 + count_tDBOutput_1, Insert.CUSTOMER_DELIVERY_NUMBER);
...
} else {pstmtInsert_tDBOutput_1.setInt(2, Insert.MATERIAL_ID);
}

                        if(Insert.CUSTOMER_ID == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(3, Insert.CUSTOMER_ID);
}

                        if(Insert.PO_NO == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, Insert.PO_NO);
}

                        if(Insert.PO_Key == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(5, Insert.PO_Key);
}

                        if(Insert.RELEASE_ID == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(6, Insert.RELEASE_ID);
}

                        if(Insert.QUANTITY == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_1.setDouble(7, Insert.QUANTITY);
}

                        if(Insert.SHIPPING_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(8, new java.sql.Timestamp(Insert.SHIPPING_DATE.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.TIMESTAMP);
}

                        if(Insert.THEORICAL_DELIVERY_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(Insert.THEORICAL_DELIVERY_DATE.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_1.setInt(10, Insert.PO_LINE_KEY);

                        pstmtInsert_tDBOutput_1.setInt(11, Insert.CUSTOMER_DELIVERY_NUMBER);

                        if(Insert.DELIVERY_CREATION_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(12, new java.sql.Timestamp(Insert.DELIVERY_CREATION_DATE.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(12, java.sql.Types.TIMESTAMP);
}

                        if(Insert.DELIVERY_MODIFICATION_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(13, new java.sql.Timestamp(Insert.DELIVERY_MODIFICATION_DATE.getTime()));
} else {
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
            ...
            if(!whetherReject_tDBOutput_1) {
                            row2 = new row2Struct();
                                ...
                                row2.CUSTOMER_ID = Insert.CUSTOMER_ID;
                                row2.PO_NO = Insert.PO_NO;
                                row2.PO_Key = Insert.PO_Key;
                                row2.RELEASE_ID = Insert.RELEASE_ID;
                                row2.QUANTITY = Insert.QUANTITY;
                                row2.SHIPPING_DATE = Insert.SHIPPING_DATE;
                                row2.THEORICAL_DELIVERY_DATE = Insert.THEORICAL_DELIVERY_DATE;
                                row2.PO_LINE_KEY = Insert.PO_LINE_KEY;
                                row2.CUSTOMER_DELIVERY_NUMBER = Insert.CUSTOMER_DELIVERY_NUMBER;
                                row2.DELIVERY_CREATION_DATE = Insert.DELIVERY_CREATION_DATE;
                                row2.DELIVERY_MODIFICATION_DATE = Insert.DELIVERY_MODIFICATION_DATE;
            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row3,row4) outputs:(Insert)
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public String loopKey;
			    ...
			    public String CUSTOMER_CODE_UNIQUE;

				public String getCUSTOMER_CODE_UNIQUE () {
					return this.CUSTOMER_CODE_UNIQUE;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.CUSTOMER_CODE_UNIQUE == null) ? 0 : this.CUSTOMER_CODE_UNIQUE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row4Struct other = (row4Struct) obj;
						...
						if (this.CUSTOMER_CODE_UNIQUE == null) {
							if (other.CUSTOMER_CODE_UNIQUE != null)
								return false;
						
						} else if (!this.CUSTOMER_CODE_UNIQUE.equals(other.CUSTOMER_CODE_UNIQUE))
	...
	public void copyDataTo(row4Struct other) {
		...
		other.CUSTOMER_ID = this.CUSTOMER_ID;
	            other.CUSTOMER_CODE_UNIQUE = this.CUSTOMER_CODE_UNIQUE;
		...
		synchronized(commonByteArrayLock_ODS_SALES_DELIVERY_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.CUSTOMER_CODE_UNIQUE = readString(dis);
    ...
    public void writeKeysData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.CUSTOMER_CODE_UNIQUE,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("CUSTOMER_ID="+String.valueOf(CUSTOMER_ID));
		sb.append(",CUSTOMER_CODE_UNIQUE="+CUSTOMER_CODE_UNIQUE);
	    sb.append("]");
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.CUSTOMER_CODE_UNIQUE, other.CUSTOMER_CODE_UNIQUE);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "SELECT [CUSTOMER_ID]\n      ,[CUSTOMER_CODE_UNIQUE]\n  FROM [DIM_COMMON_CUSTOMER]\n";
            ...
            row4.CUSTOMER_ID = rs_tDBInput_3.getInt(1);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row4.CUSTOMER_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.CUSTOMER_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row4.CUSTOMER_CODE_UNIQUE = tmpContent_tDBInput_3;
                }
            } else {
                row4.CUSTOMER_CODE_UNIQUE = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.CUSTOMER_CODE_UNIQUE = row4.CUSTOMER_CODE_UNIQUE;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Main_Template.class.getClassLoader().getResourceAsStream("ods_sales_delivery/main_template_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     314177 characters generated by Talend Open Studio for Data Integration 
 *     on the September 18, 2024 at 3:05:29 PM CST
 ************************************************************************************************/