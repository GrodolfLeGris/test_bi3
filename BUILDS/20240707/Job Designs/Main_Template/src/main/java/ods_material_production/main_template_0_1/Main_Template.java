...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [ORGANIZATIONLVL3ID] = ? AND [REPORT_DATE] = ? AND [SERIAL_NO] = ?");
        ...
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [MATERIAL_ID] = ?,[QUANTITY] = ?,[TRANSACTION_DATE] = ?,[REJECTED] = ?,[OPERATION_ID] = ?,[INVENTORY_TYPE] = ?,[LOCATION_ID] = ?,[BUILDING_ID] = ? WHERE [ORGANIZATIONLVL3ID] = ? AND [REPORT_DATE] = ? AND [SERIAL_NO] = ?";
...
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.TIMESTAMP);
                        ...
                        pstmtUpdate_tDBOutput_1.setInt(5, Insert.OPERATION_ID);
...
pstmtUpdate_tDBOutput_1.setNull(9 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(9 + count_tDBOutput_1, Insert.ORGANIZATIONLVL3ID);
}
                        ...
                        if(Insert.REPORT_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(10 + count_tDBOutput_1, new java.sql.Timestamp(Insert.REPORT_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(10 + count_tDBOutput_1, java.sql.Types.TIMESTAMP);
}
...
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.TIMESTAMP);
                        ...
                        pstmtInsert_tDBOutput_1.setInt(7, Insert.OPERATION_ID);
...
/************************************************************************************************
 *     322173 characters generated by Talend Open Studio for Data Integration 
 *     on the July 7, 2024 at 1:06:11 PM CST
 ************************************************************************************************/