...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
	...
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([ORGANIZATIONLVL3ID],[MATERIAL_ID],[RELEASE_NO],[RELEASE_ID],[RELEASE_STATUS],[PO],[PO_LINE_KEY],[QUANTITY],[PRELIMINARY_DUE_DATE],[SNAPSHOT_DATE],[DUE_DATE],[RELEASE_SOURCE],[RELEASE_TYPE],[FIRM],[PLANNING],[FORECAST_INCLUDE]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [MATERIAL_ID] = ?,[RELEASE_NO] = ?,[RELEASE_STATUS] = ?,[PO] = ?,[QUANTITY] = ?,[PRELIMINARY_DUE_DATE] = ?,[DUE_DATE] = ?,[RELEASE_SOURCE] = ?,[RELEASE_TYPE] = ?,[FIRM] = ?,[PLANNING] = ?,[FORECAST_INCLUDE] = ? WHERE [ORGANIZATIONLVL3ID] = ? AND [RELEASE_ID] = ? AND [PO_LINE_KEY] = ? AND [SNAPSHOT_DATE] = ?";
...
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
                        ...
                        if(Insert.ORGANIZATIONLVL3ID == null) {
pstmtUpdate_tDBOutput_1.setNull(13 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(13 + count_tDBOutput_1, Insert.ORGANIZATIONLVL3ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setInt(14 + count_tDBOutput_1, Insert.RELEASE_ID);
}
...
pstmtUpdate_tDBOutput_1.setNull(15 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(15 + count_tDBOutput_1, Insert.PO_LINE_KEY);
}
                        ...
                        if(Insert.SNAPSHOT_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(16 + count_tDBOutput_1, new java.sql.Timestamp(Insert.SNAPSHOT_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(16 + count_tDBOutput_1, java.sql.Types.TIMESTAMP);
}
...
/************************************************************************************************
 *     280686 characters generated by Talend Open Studio for Data Integration 
 *     on the July 8, 2024 at 9:28:10 AM CST
 ************************************************************************************************/