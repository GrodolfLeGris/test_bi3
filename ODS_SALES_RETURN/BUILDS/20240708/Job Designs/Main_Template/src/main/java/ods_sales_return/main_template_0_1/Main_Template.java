...
package ods_sales_return.main_template_0_1;
...
public String getTALEND_CONF_FileSeparator(){
	...
	private final String projectName = "ODS_SALES_RETURN";
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_ODS_SALES_RETURN_Main_Template = new byte[0];
    static byte[] commonByteArray_ODS_SALES_RETURN_Main_Template = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_SALES_RETURN_Main_Template.length) {
				if(length < 1024 && commonByteArray_ODS_SALES_RETURN_Main_Template.length == 0) {
   					commonByteArray_ODS_SALES_RETURN_Main_Template = new byte[1024];
				} else {
   					commonByteArray_ODS_SALES_RETURN_Main_Template = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_SALES_RETURN_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_RETURN_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_SALES_RETURN_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_RETURN_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_SALES_RETURN_Main_Template) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ods_sales_return.load_context_0_1.Load_context childJob_tRunJob_1 = new ods_sales_return.load_context_0_1.Load_context();
	    // pass DataSources
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public String loopKey;
			    ...
			    public double REPORTED_QUANTITY;

				public double getREPORTED_QUANTITY () {
					return this.REPORTED_QUANTITY;
				}
				
			    public double RETURNED_QUANTITY;

				public double getRETURNED_QUANTITY () {
					return this.RETURNED_QUANTITY;
				}
				
			    public double DEFECTIVE_QUANTITY;

				public double getDEFECTIVE_QUANTITY () {
					return this.DEFECTIVE_QUANTITY;
				}
				
			    public double INCLUDE_IN_PPM;

				public double getINCLUDE_IN_PPM () {
					return this.INCLUDE_IN_PPM;
				}
				
			    public double CREDIT_QUANTITY;

				public double getCREDIT_QUANTITY () {
					return this.CREDIT_QUANTITY;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.RETURN_NO == null) ? 0 : this.RETURN_NO.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						if (this.RETURN_NO == null) {
							if (other.RETURN_NO != null)
								return false;
						
						} else if (!this.RETURN_NO.equals(other.RETURN_NO))
	...
	public void copyDataTo(row2Struct other) {
		...
		other.ORGANIZATIONLVL3ID = this.ORGANIZATIONLVL3ID;
	            ...
	            other.RETURN_NO = this.RETURN_NO;
	            ...
	            other.RETURN_ID = this.RETURN_ID;
	            other.REPORTED_QUANTITY = this.REPORTED_QUANTITY;
	            other.RETURNED_QUANTITY = this.RETURNED_QUANTITY;
	            other.DEFECTIVE_QUANTITY = this.DEFECTIVE_QUANTITY;
	            other.INCLUDE_IN_PPM = this.INCLUDE_IN_PPM;
	            other.CREDIT_QUANTITY = this.CREDIT_QUANTITY;
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.MATERIAL_ID = dis.readInt();
						...
						this.RETURN_NO = readInteger(dis);
			        ...
			        this.RETURN_ID = dis.readInt();
					
			        this.REPORTED_QUANTITY = dis.readDouble();
					
			        this.RETURNED_QUANTITY = dis.readDouble();
					
			        this.DEFECTIVE_QUANTITY = dis.readDouble();
					
			        this.INCLUDE_IN_PPM = dis.readDouble();
					
			        this.CREDIT_QUANTITY = dis.readDouble();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.RETURN_NO,dos);
					...
					// int
		            	...
		            	dos.writeInt(this.RETURN_ID);
					
					// double
				
		            	dos.writeDouble(this.REPORTED_QUANTITY);
					
					// double
				
		            	dos.writeDouble(this.RETURNED_QUANTITY);
					
					// double
				
		            	dos.writeDouble(this.DEFECTIVE_QUANTITY);
					
					// double
				
		            	dos.writeDouble(this.INCLUDE_IN_PPM);
					
					// double
				
		            	dos.writeDouble(this.CREDIT_QUANTITY);
    ...
    public String toString() {
		...
		sb.append(",RETURN_NO="+String.valueOf(RETURN_NO));
		...
		sb.append(",RETURN_ID="+String.valueOf(RETURN_ID));
		sb.append(",REPORTED_QUANTITY="+String.valueOf(REPORTED_QUANTITY));
		sb.append(",RETURNED_QUANTITY="+String.valueOf(RETURNED_QUANTITY));
		sb.append(",DEFECTIVE_QUANTITY="+String.valueOf(DEFECTIVE_QUANTITY));
		sb.append(",INCLUDE_IN_PPM="+String.valueOf(INCLUDE_IN_PPM));
		sb.append(",CREDIT_QUANTITY="+String.valueOf(CREDIT_QUANTITY));
	    sb.append("]");
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.RETURN_NO, other.RETURN_NO);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ODS_SALES_RETURN_Main_Template = new byte[0];
			    ...
			    public Integer Create_Memo;

				public Integer getCreate_Memo () {
					return this.Create_Memo;
				}
			    ...
			    public Integer Include_in_PPM;

				public Integer getInclude_in_PPM () {
					return this.Include_in_PPM;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Category = readString(dis);
						...
						this.Create_Memo = readInteger(dis);
					
						this.RETURN_ID = readInteger(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Reported_Quantity = null;
           				} else {
           			    	this.Reported_Quantity = dis.readDouble();
           				}
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Defective_Quantity = null;
           				} else {
           			    	this.Defective_Quantity = dis.readDouble();
           				}
					
						this.Include_in_PPM = readInteger(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Credit_Quantity = null;
           				} else {
           			    	this.Credit_Quantity = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.Return_No,dos);
					...
					// Integer
						...
						writeInteger(this.Create_Memo,dos);
					
					// Integer
				
						writeInteger(this.RETURN_ID,dos);
					
					// Double
				
						if(this.Reported_Quantity == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.Reported_Quantity);
					...
					// Double
						...
						if(this.Defective_Quantity == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.Defective_Quantity);
					...
					// Integer
						...
						writeInteger(this.Include_in_PPM,dos);
					
					// Double
				
						if(this.Credit_Quantity == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.Credit_Quantity);
    ...
    public String toString() {
		...
		sb.append(",Return_No="+Return_No);
		sb.append(",Description="+Description);
		sb.append(",TRANSACTION_DATE="+TRANSACTION_DATE);
		sb.append(",REPORT_DATE="+REPORT_DATE);
		sb.append(",Return_Reason="+Return_Reason);
		sb.append(",Category="+Category);
		sb.append(",Create_Memo="+String.valueOf(Create_Memo));
		sb.append(",RETURN_ID="+String.valueOf(RETURN_ID));
		sb.append(",Reported_Quantity="+String.valueOf(Reported_Quantity));
		sb.append(",Returned_Quantity="+String.valueOf(Returned_Quantity));
		sb.append(",Defective_Quantity="+String.valueOf(Defective_Quantity));
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "ODS_SALES_RETURN";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "ODS_SALES_RETURN";
}
	int count_tDBOutput_1=0;

        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [ORGANIZATIONLVL3ID] = ? AND [RETURN_NO] = ?");
        resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([ORGANIZATIONLVL3ID],[MATERIAL_ID],[RETURN_NO],[DESCRIPTION],[TRANSACTION_DATE],[REPORT_DATE],[RETURN_REASON],[CATEGORY],[RETURN_ID],[REPORTED_QUANTITY],[RETURNED_QUANTITY],[DEFECTIVE_QUANTITY],[INCLUDE_IN_PPM],[CREDIT_QUANTITY]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [MATERIAL_ID] = ?,[DESCRIPTION] = ?,[TRANSACTION_DATE] = ?,[REPORT_DATE] = ?,[RETURN_REASON] = ?,[CATEGORY] = ?,[RETURN_ID] = ?,[REPORTED_QUANTITY] = ?,[RETURNED_QUANTITY] = ?,[DEFECTIVE_QUANTITY] = ?,[INCLUDE_IN_PPM] = ?,[CREDIT_QUANTITY] = ? WHERE [ORGANIZATIONLVL3ID] = ? AND [RETURN_NO] = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nEXEC ('sproc278344_10639364_1891083') AT [PLEX]\n";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Return_No = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Return_No = tmpContent_tDBInput_1;
                }
            } else {
                row1.Return_No = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Return_Reason = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Return_Reason = tmpContent_tDBInput_1;
                }
            } else {
                row1.Return_Reason = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
                ...
                row1.Category = null;
							...
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.Create_Memo = null;
							} else {
		                          
            row1.Create_Memo = rs_tDBInput_1.getInt(9);
            if(rs_tDBInput_1.wasNull()){
                    row1.Create_Memo = null;
            }
		                    }
            ...
            row1.RETURN_ID = rs_tDBInput_1.getInt(10);
            if(rs_tDBInput_1.wasNull()){
                    row1.RETURN_ID = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 11) {
								row1.Reported_Quantity = null;
							} else {
	                         		
            row1.Reported_Quantity = rs_tDBInput_1.getDouble(11);
            if(rs_tDBInput_1.wasNull()){
                    row1.Reported_Quantity = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 12) {
								row1.Returned_Quantity = null;
							} else {
	                         		
            row1.Returned_Quantity = rs_tDBInput_1.getDouble(12);
            if(rs_tDBInput_1.wasNull()){
                    row1.Returned_Quantity = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 13) {
								row1.Defective_Quantity = null;
							} else {
	                         		
            row1.Defective_Quantity = rs_tDBInput_1.getDouble(13);
            if(rs_tDBInput_1.wasNull()){
                    row1.Defective_Quantity = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 14) {
								row1.Include_in_PPM = null;
							} else {
		                          
            row1.Include_in_PPM = rs_tDBInput_1.getInt(14);
            if(rs_tDBInput_1.wasNull()){
                    row1.Include_in_PPM = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 15) {
								row1.Credit_Quantity = null;
							} else {
	                         		
            row1.Credit_Quantity = rs_tDBInput_1.getDouble(15);
            if(rs_tDBInput_1.wasNull()){
                    row1.Credit_Quantity = null;
            }
		                    }
...
Insert_tmp.RETURN_NO = Integer.parseInt(row1.Return_No);
Insert_tmp.DESCRIPTION = row1.Description ;
...
Insert_tmp.RETURN_REASON = row1.Return_Reason ;
Insert_tmp.CATEGORY = row1.Category ;
Insert_tmp.RETURN_ID = row1.RETURN_ID ;
Insert_tmp.REPORTED_QUANTITY = row1.Reported_Quantity ;
Insert_tmp.RETURNED_QUANTITY = row1.Returned_Quantity ;
Insert_tmp.DEFECTIVE_QUANTITY = row1.Defective_Quantity ;
Insert_tmp.INCLUDE_IN_PPM = row1.Include_in_PPM;
Insert_tmp.CREDIT_QUANTITY = row1.Credit_Quantity ;
Insert = Insert_tmp;
// ###############################
...
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
                    ...
                    if(Insert.RETURN_NO == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, Insert.RETURN_NO);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(2, Insert.DESCRIPTION);
}
...
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
                        ...
                        if(Insert.RETURN_REASON == null) {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(5, Insert.RETURN_REASON);
}

                        if(Insert.CATEGORY == null) {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(6, Insert.CATEGORY);
}

                        pstmtUpdate_tDBOutput_1.setInt(7, Insert.RETURN_ID);

                        pstmtUpdate_tDBOutput_1.setDouble(8, Insert.REPORTED_QUANTITY);

                        pstmtUpdate_tDBOutput_1.setDouble(9, Insert.RETURNED_QUANTITY);

                        pstmtUpdate_tDBOutput_1.setDouble(10, Insert.DEFECTIVE_QUANTITY);

                        pstmtUpdate_tDBOutput_1.setDouble(11, Insert.INCLUDE_IN_PPM);

                        pstmtUpdate_tDBOutput_1.setDouble(12, Insert.CREDIT_QUANTITY);
...
} else {pstmtUpdate_tDBOutput_1.setInt(14 + count_tDBOutput_1, Insert.RETURN_NO);
}
...
} else {pstmtInsert_tDBOutput_1.setInt(3, Insert.RETURN_NO);
}

                        if(Insert.DESCRIPTION == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(4, Insert.DESCRIPTION);
}
...
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.TIMESTAMP);
                        ...
                        if(Insert.REPORT_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(Insert.REPORT_DATE.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(7, Insert.RETURN_REASON);
}

                        if(Insert.CATEGORY == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, Insert.CATEGORY);
}

                        pstmtInsert_tDBOutput_1.setInt(9, Insert.RETURN_ID);

                        pstmtInsert_tDBOutput_1.setDouble(10, Insert.REPORTED_QUANTITY);

                        pstmtInsert_tDBOutput_1.setDouble(11, Insert.RETURNED_QUANTITY);

                        pstmtInsert_tDBOutput_1.setDouble(12, Insert.DEFECTIVE_QUANTITY);

                        pstmtInsert_tDBOutput_1.setDouble(13, Insert.INCLUDE_IN_PPM);

                        pstmtInsert_tDBOutput_1.setDouble(14, Insert.CREDIT_QUANTITY);
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
            ...
            if(!whetherReject_tDBOutput_1) {
                            row2 = new row2Struct();
                                ...
                                row2.RETURN_NO = Insert.RETURN_NO;
                                row2.DESCRIPTION = Insert.DESCRIPTION;
                                row2.TRANSACTION_DATE = Insert.TRANSACTION_DATE;
                                row2.REPORT_DATE = Insert.REPORT_DATE;
                                row2.RETURN_REASON = Insert.RETURN_REASON;
                                row2.CATEGORY = Insert.CATEGORY;
                                row2.RETURN_ID = Insert.RETURN_ID;
                                row2.REPORTED_QUANTITY = Insert.REPORTED_QUANTITY;
                                row2.RETURNED_QUANTITY = Insert.RETURNED_QUANTITY;
                                row2.DEFECTIVE_QUANTITY = Insert.DEFECTIVE_QUANTITY;
                                row2.INCLUDE_IN_PPM = Insert.INCLUDE_IN_PPM;
                                row2.CREDIT_QUANTITY = Insert.CREDIT_QUANTITY;
            }
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Main_Template.class.getClassLoader().getResourceAsStream("ods_sales_return/main_template_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     273418 characters generated by Talend Open Studio for Data Integration 
 *     on the July 8, 2024 at 9:39:38 AM CST
 ************************************************************************************************/