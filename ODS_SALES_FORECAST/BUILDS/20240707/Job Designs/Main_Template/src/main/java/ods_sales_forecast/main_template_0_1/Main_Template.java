...
package ods_sales_forecast.main_template_0_1;
...
public String getTALEND_CONF_FileSeparator(){
	...
	private final String projectName = "ODS_SALES_FORECAST";
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_ODS_SALES_FORECAST_Main_Template = new byte[0];
    static byte[] commonByteArray_ODS_SALES_FORECAST_Main_Template = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_SALES_FORECAST_Main_Template.length) {
				if(length < 1024 && commonByteArray_ODS_SALES_FORECAST_Main_Template.length == 0) {
   					commonByteArray_ODS_SALES_FORECAST_Main_Template = new byte[1024];
				} else {
   					commonByteArray_ODS_SALES_FORECAST_Main_Template = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_SALES_FORECAST_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_FORECAST_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_SALES_FORECAST_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_FORECAST_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_SALES_FORECAST_Main_Template) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ods_sales_forecast.load_context_0_1.Load_context childJob_tRunJob_1 = new ods_sales_forecast.load_context_0_1.Load_context();
	    // pass DataSources
		...
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.ORGANIZATIONLVL3ID == null) ? 0 : this.ORGANIZATIONLVL3ID.hashCode());
							...
							result = prime * result + (int) this.MATERIAL_ID;
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "ODS_SALES_FORECAST";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "ODS_SALES_FORECAST";
}
	int count_tDBOutput_1=0;

        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [ORGANIZATIONLVL3ID] = ? AND [MATERIAL_ID] = ? AND [RELEASE_ID] = ? AND [PO_LINE_KEY] = ? AND [SNAPSHOT_DATE] = ?");
        ...
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [RELEASE_NO] = ?,[RELEASE_STATUS] = ?,[PO] = ?,[QUANTITY] = ?,[PRELIMINARY_DUE_DATE] = ?,[DUE_DATE] = ?,[RELEASE_SOURCE] = ?,[RELEASE_TYPE] = ?,[FIRM] = ?,[PLANNING] = ?,[FORECAST_INCLUDE] = ?,[UNIT_PRICE] = ?,[UNIT_COST] = ? WHERE [ORGANIZATIONLVL3ID] = ? AND [MATERIAL_ID] = ? AND [RELEASE_ID] = ? AND [PO_LINE_KEY] = ? AND [SNAPSHOT_DATE] = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nEXEC ('sproc278344_10639364_1837933') AT [PLEX]\n";
...
Insert_tmp.PRELIMINARY_DUE_DATE = TalendDate.parseDate("yyyy-MM-dd",row1.PRELIMINARY_DUE_DATE ) ;
Insert_tmp.SNAPSHOT_DATE = TalendDate.parseDate("yyyy-MM-dd",row1.SNAPSHOT_DATE) ;
Insert_tmp.DUE_DATE = TalendDate.parseDate("yyyy-MM-dd",row1.DUE_DATE) ;
...
pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
                    ...
                    pstmt_tDBOutput_1.setInt(2, Insert.MATERIAL_ID);



                    if(Insert.RELEASE_ID == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, Insert.RELEASE_ID);
}
...
} else {pstmt_tDBOutput_1.setInt(4, Insert.PO_LINE_KEY);
}



                    if(Insert.SNAPSHOT_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(Insert.SNAPSHOT_DATE.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_1.setString(1, Insert.RELEASE_NO);
}

                        if(Insert.RELEASE_STATUS == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, Insert.RELEASE_STATUS);
}

                        if(Insert.PO == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, Insert.PO);
}

                        pstmtUpdate_tDBOutput_1.setDouble(4, Insert.QUANTITY);

                        if(Insert.PRELIMINARY_DUE_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(Insert.PRELIMINARY_DUE_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(5, java.sql.Types.TIMESTAMP);
}

                        if(Insert.DUE_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(Insert.DUE_DATE.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_1.setString(7, Insert.RELEASE_SOURCE);
}

                        if(Insert.RELEASE_TYPE == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8, Insert.RELEASE_TYPE);
}

                        pstmtUpdate_tDBOutput_1.setBoolean(9, Insert.FIRM);

                        pstmtUpdate_tDBOutput_1.setBoolean(10, Insert.PLANNING);

                        pstmtUpdate_tDBOutput_1.setBoolean(11, Insert.FORECAST_INCLUDE);

                        pstmtUpdate_tDBOutput_1.setDouble(12, Insert.UNIT_PRICE);

                        pstmtUpdate_tDBOutput_1.setDouble(13, Insert.UNIT_COST);
...
} else {pstmtUpdate_tDBOutput_1.setInt(14 + count_tDBOutput_1, Insert.ORGANIZATIONLVL3ID);
}


	                    

                        pstmtUpdate_tDBOutput_1.setInt(15 + count_tDBOutput_1, Insert.MATERIAL_ID);
...
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
                        ...
                        pstmtInsert_tDBOutput_1.setDouble(17, Insert.UNIT_PRICE);

                        pstmtInsert_tDBOutput_1.setDouble(18, Insert.UNIT_COST);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Main_Template.class.getClassLoader().getResourceAsStream("ods_sales_forecast/main_template_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     283987 characters generated by Talend Open Studio for Data Integration 
 *     on the July 7, 2024 at 3:29:25 PM CST
 ************************************************************************************************/