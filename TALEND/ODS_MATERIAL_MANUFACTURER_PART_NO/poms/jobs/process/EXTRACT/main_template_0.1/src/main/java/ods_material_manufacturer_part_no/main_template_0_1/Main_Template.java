...
package ods_material_manufacturer_part_no.main_template_0_1;
...
public String getTALEND_CONF_FileSeparator(){
	...
	private final String projectName = "ODS_MATERIAL_MANUFACTURER_PART_NO";
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template = new byte[0];
    static byte[] commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template.length) {
				if(length < 1024 && commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template.length == 0) {
   					commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template = new byte[1024];
				} else {
   					commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ods_material_manufacturer_part_no.load_context_0_1.Load_context childJob_tRunJob_1 = new ods_material_manufacturer_part_no.load_context_0_1.Load_context();
	    // pass DataSources
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public String loopKey;
				...
				public String getMANUFACTURER_PART_NO () {
					return this.MANUFACTURER_PART_NO;
				}
				
			    public String MANUFACTURER_PART_STATUS;

				public String getMANUFACTURER_PART_STATUS () {
					return this.MANUFACTURER_PART_STATUS;
				}
			    ...
			    public Boolean PRIMARY_SUPPLIER;

				public Boolean getPRIMARY_SUPPLIER () {
					return this.PRIMARY_SUPPLIER;
				}
				
			    public String MANUFACTURER_PART_KEY_UNIQUE;

				public String getMANUFACTURER_PART_KEY_UNIQUE () {
					return this.MANUFACTURER_PART_KEY_UNIQUE;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.MATERIAL_ID == null) ? 0 : this.MATERIAL_ID.hashCode());
					
						result = prime * result + ((this.SUPPLIER_ID == null) ? 0 : this.SUPPLIER_ID.hashCode());
					
						result = prime * result + ((this.MANUFACTURER_ID == null) ? 0 : this.MANUFACTURER_ID.hashCode());
					
						result = prime * result + ((this.MANUFACTURER_PART_KEY_UNIQUE == null) ? 0 : this.MANUFACTURER_PART_KEY_UNIQUE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						if (this.MANUFACTURER_ID == null) {
							if (other.MANUFACTURER_ID != null)
								return false;
						
						} else if (!this.MANUFACTURER_ID.equals(other.MANUFACTURER_ID))
						
							return false;
					
						if (this.MANUFACTURER_PART_KEY_UNIQUE == null) {
							if (other.MANUFACTURER_PART_KEY_UNIQUE != null)
								return false;
						
						} else if (!this.MANUFACTURER_PART_KEY_UNIQUE.equals(other.MANUFACTURER_PART_KEY_UNIQUE))
	...
	public void copyDataTo(row2Struct other) {
		...
		other.MATERIAL_ID = this.MATERIAL_ID;
	            other.MANUFACTURER_PART_NO = this.MANUFACTURER_PART_NO;
	            other.MANUFACTURER_PART_STATUS = this.MANUFACTURER_PART_STATUS;
	            other.ACTIVE = this.ACTIVE;
	            other.SUPPLIER_ID = this.SUPPLIER_ID;
	            other.MANUFACTURER_ID = this.MANUFACTURER_ID;
	            other.PRIMARY_SUPPLIER = this.PRIMARY_SUPPLIER;
	            other.MANUFACTURER_PART_KEY_UNIQUE = this.MANUFACTURER_PART_KEY_UNIQUE;
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.MANUFACTURER_PART_NO = readString(dis);
					
					this.MANUFACTURER_PART_STATUS = readString(dis);
						...
						this.MANUFACTURER_ID = readInteger(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.PRIMARY_SUPPLIER = null;
           				} else {
           			    	this.PRIMARY_SUPPLIER = dis.readBoolean();
           				}
					
					this.MANUFACTURER_PART_KEY_UNIQUE = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.MANUFACTURER_PART_NO,dos);
					
					// String
				
						writeString(this.MANUFACTURER_PART_STATUS,dos);
					...
					// Integer
						...
						writeInteger(this.MANUFACTURER_ID,dos);
					
					// Boolean
				
						if(this.PRIMARY_SUPPLIER == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeBoolean(this.PRIMARY_SUPPLIER);
		            	}
					
					// String
				
						writeString(this.MANUFACTURER_PART_KEY_UNIQUE,dos);
    ...
    public String toString() {
		...
		sb.append(",MANUFACTURER_PART_NO="+MANUFACTURER_PART_NO);
		sb.append(",MANUFACTURER_PART_STATUS="+MANUFACTURER_PART_STATUS);
		...
		sb.append(",PRIMARY_SUPPLIER="+String.valueOf(PRIMARY_SUPPLIER));
		sb.append(",MANUFACTURER_PART_KEY_UNIQUE="+MANUFACTURER_PART_KEY_UNIQUE);
	    sb.append("]");
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.MATERIAL_ID, other.MATERIAL_ID);
						if(returnValue != 0) {
							return returnValue;
						}
						...
						returnValue = checkNullsAndCompare(this.MANUFACTURER_ID, other.MANUFACTURER_ID);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.MANUFACTURER_PART_KEY_UNIQUE, other.MANUFACTURER_PART_KEY_UNIQUE);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template = new byte[0];
			    ...
			    public String MANUFACTUER_PART_NO;

				public String getMANUFACTUER_PART_NO () {
					return this.MANUFACTUER_PART_NO;
				}
			    ...
			    public String MANUFACTURER_CODE_UNIQUE;

				public String getMANUFACTURER_CODE_UNIQUE () {
					return this.MANUFACTURER_CODE_UNIQUE;
				}
				
			    public String SUPPLIER_CODE_UNIQUE;

				public String getSUPPLIER_CODE_UNIQUE () {
					return this.SUPPLIER_CODE_UNIQUE;
				}
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_MANUFACTURER_PART_NO_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.MANUFACTUER_PART_NO = readString(dis);
					...
					this.MANUFACTURER_CODE_UNIQUE = readString(dis);
					
					this.SUPPLIER_CODE_UNIQUE = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.MANUFACTUER_PART_NO,dos);
					...
					// String
						...
						writeString(this.MANUFACTURER_CODE_UNIQUE,dos);
					
					// String
				
						writeString(this.SUPPLIER_CODE_UNIQUE,dos);
    ...
    public String toString() {
		...
		sb.append(",MANUFACTUER_PART_NO="+MANUFACTUER_PART_NO);
		sb.append(",MANUFACTURER_PART_STATUS="+MANUFACTURER_PART_STATUS);
		sb.append(",ACTIVE="+String.valueOf(ACTIVE));
		sb.append(",PRIMARY_SUPPLIER="+String.valueOf(PRIMARY_SUPPLIER));
		sb.append(",MANUFACTURER_CODE_UNIQUE="+MANUFACTURER_CODE_UNIQUE);
		sb.append(",SUPPLIER_CODE_UNIQUE="+SUPPLIER_CODE_UNIQUE);
	    sb.append("]");
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "ODS_MATERIAL_MANUFACTURER_PART_NO";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "ODS_MATERIAL_MANUFACTURER_PART_NO";
}
	int count_tDBOutput_1=0;

        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [MATERIAL_ID] = ? AND [SUPPLIER_ID] = ? AND [MANUFACTURER_ID] = ? AND [MANUFACTURER_PART_KEY_UNIQUE] = ?");
        resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([MATERIAL_ID],[MANUFACTURER_PART_NO],[MANUFACTURER_PART_STATUS],[ACTIVE],[SUPPLIER_ID],[MANUFACTURER_ID],[PRIMARY_SUPPLIER],[MANUFACTURER_PART_KEY_UNIQUE]) VALUES (?,?,?,?,?,?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [MANUFACTURER_PART_NO] = ?,[MANUFACTURER_PART_STATUS] = ?,[ACTIVE] = ?,[PRIMARY_SUPPLIER] = ? WHERE [MATERIAL_ID] = ? AND [SUPPLIER_ID] = ? AND [MANUFACTURER_ID] = ? AND [MANUFACTURER_PART_KEY_UNIQUE] = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nEXEC ('sproc278344_10639364_1848077') AT [PLEX]\n";
		    ...
		    while (rs_tDBInput_1.next()) {
		        nb_line_tDBInput_1++;
							...
							if(colQtyInRs_tDBInput_1 < 1) {
								row1.MANUFACTURER_PART_KEY_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.MANUFACTURER_PART_KEY_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.MANUFACTURER_PART_KEY_UNIQUE = tmpContent_tDBInput_1;
                }
            } else {
                row1.MANUFACTURER_PART_KEY_UNIQUE = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
                ...
                row1.PART_NO_UNIQUE = null;
							...
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.MANUFACTUER_PART_NO = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(3);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.MANUFACTUER_PART_NO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.MANUFACTUER_PART_NO = tmpContent_tDBInput_1;
                }
            } else {
                row1.MANUFACTUER_PART_NO = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 4) {
								row1.MANUFACTURER_PART_STATUS = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(4);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.MANUFACTURER_PART_STATUS = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.MANUFACTURER_PART_STATUS = tmpContent_tDBInput_1;
                }
            } else {
                row1.MANUFACTURER_PART_STATUS = null;
            }
            ...
            row1.ACTIVE = rs_tDBInput_1.getInt(5);
            if(rs_tDBInput_1.wasNull()){
                    row1.ACTIVE = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 6) {
								row1.PRIMARY_SUPPLIER = null;
							} else {
	                         		
            row1.PRIMARY_SUPPLIER = rs_tDBInput_1.getBoolean(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.PRIMARY_SUPPLIER = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.MANUFACTURER_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.MANUFACTURER_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.MANUFACTURER_CODE_UNIQUE = tmpContent_tDBInput_1;
                }
            } else {
                row1.MANUFACTURER_CODE_UNIQUE = null;
            }
							...
							if(colQtyInRs_tDBInput_1 < 8) {
								row1.SUPPLIER_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.SUPPLIER_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.SUPPLIER_CODE_UNIQUE = tmpContent_tDBInput_1;
                }
            } else {
                row1.SUPPLIER_CODE_UNIQUE = null;
            }
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.SUPPLIER_CODE_UNIQUE = row1.SUPPLIER_CODE_UNIQUE ;
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.SUPPLIER_CODE_UNIQUE = '" + row3HashKey.SUPPLIER_CODE_UNIQUE + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row4HashKey.MATERIAL_NO_UNIQUE = row1.PART_NO_UNIQUE ;
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.MATERIAL_NO_UNIQUE = '" + row4HashKey.MATERIAL_NO_UNIQUE + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.MANUFACTURER_CODE_UNIQUE = row1.MANUFACTURER_CODE_UNIQUE ;
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.MANUFACTURER_CODE_UNIQUE = '" + row5HashKey.MANUFACTURER_CODE_UNIQUE + "'");
								} // G 071
...
// # Output table : 'Insert'
Insert_tmp.MATERIAL_ID = row4.MATERIAL_ID ;
Insert_tmp.MANUFACTURER_PART_NO = row1.MANUFACTUER_PART_NO ;
Insert_tmp.MANUFACTURER_PART_STATUS = row1.MANUFACTURER_PART_STATUS ;
Insert_tmp.ACTIVE = Mathematical.MOD(row1.ACTIVE ,2) == 1 ;
Insert_tmp.SUPPLIER_ID = row3.SUPPLIER_ID ;
Insert_tmp.MANUFACTURER_ID = row5.MANUFACTURER_NO ;
Insert_tmp.PRIMARY_SUPPLIER = row1.PRIMARY_SUPPLIER ;
Insert_tmp.MANUFACTURER_PART_KEY_UNIQUE = row1.MANUFACTURER_PART_KEY_UNIQUE ;
Insert = Insert_tmp;
// ###############################
...
} else {pstmt_tDBOutput_1.setInt(1, Insert.MATERIAL_ID);
}



                    if(Insert.SUPPLIER_ID == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(2, Insert.SUPPLIER_ID);
}



                    if(Insert.MANUFACTURER_ID == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, Insert.MANUFACTURER_ID);
}



                    if(Insert.MANUFACTURER_PART_KEY_UNIQUE == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, Insert.MANUFACTURER_PART_KEY_UNIQUE);
}
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        if(Insert.MANUFACTURER_PART_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(1, Insert.MANUFACTURER_PART_NO);
}

                        if(Insert.MANUFACTURER_PART_STATUS == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, Insert.MANUFACTURER_PART_STATUS);
}

                        if(Insert.ACTIVE == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(3, Insert.ACTIVE);
}

                        if(Insert.PRIMARY_SUPPLIER == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(4, Insert.PRIMARY_SUPPLIER);
}
...
} else {pstmtUpdate_tDBOutput_1.setInt(5 + count_tDBOutput_1, Insert.MATERIAL_ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setInt(6 + count_tDBOutput_1, Insert.SUPPLIER_ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setInt(7 + count_tDBOutput_1, Insert.MANUFACTURER_ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(8 + count_tDBOutput_1, Insert.MANUFACTURER_PART_KEY_UNIQUE);
}
...
} else {pstmtInsert_tDBOutput_1.setInt(1, Insert.MATERIAL_ID);
}

                        if(Insert.MANUFACTURER_PART_NO == null) {
pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(2, Insert.MANUFACTURER_PART_NO);
}

                        if(Insert.MANUFACTURER_PART_STATUS == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, Insert.MANUFACTURER_PART_STATUS);
}

                        if(Insert.ACTIVE == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_1.setBoolean(4, Insert.ACTIVE);
}

                        if(Insert.SUPPLIER_ID == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(5, Insert.SUPPLIER_ID);
}

                        if(Insert.MANUFACTURER_ID == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(6, Insert.MANUFACTURER_ID);
}

                        if(Insert.PRIMARY_SUPPLIER == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_1.setBoolean(7, Insert.PRIMARY_SUPPLIER);
}

                        if(Insert.MANUFACTURER_PART_KEY_UNIQUE == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, Insert.MANUFACTURER_PART_KEY_UNIQUE);
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
            ...
            if(!whetherReject_tDBOutput_1) {
                            row2 = new row2Struct();
                                ...
                                row2.MANUFACTURER_PART_NO = Insert.MANUFACTURER_PART_NO;
                                row2.MANUFACTURER_PART_STATUS = Insert.MANUFACTURER_PART_STATUS;
                                row2.ACTIVE = Insert.ACTIVE;
                                row2.SUPPLIER_ID = Insert.SUPPLIER_ID;
                                row2.MANUFACTURER_ID = Insert.MANUFACTURER_ID;
                                row2.PRIMARY_SUPPLIER = Insert.PRIMARY_SUPPLIER;
                                row2.MANUFACTURER_PART_KEY_UNIQUE = Insert.MANUFACTURER_PART_KEY_UNIQUE;
            }
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.SUPPLIER_CODE_UNIQUE == null) ? 0 : this.SUPPLIER_CODE_UNIQUE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row3Struct other = (row3Struct) obj;
						...
						if (this.SUPPLIER_CODE_UNIQUE == null) {
							if (other.SUPPLIER_CODE_UNIQUE != null)
								return false;
						
						} else if (!this.SUPPLIER_CODE_UNIQUE.equals(other.SUPPLIER_CODE_UNIQUE))
	...
	public void copyDataTo(row3Struct other) {
		...
		other.SUPPLIER_ID = this.SUPPLIER_ID;
	            other.SUPPLIER_CODE_UNIQUE = this.SUPPLIER_CODE_UNIQUE;
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.SUPPLIER_ID = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.SUPPLIER_ID);
    ...
    public int compareTo(row3Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.SUPPLIER_CODE_UNIQUE, other.SUPPLIER_CODE_UNIQUE);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row3,row4,row5) outputs:(Insert)
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "SELECT [SUPPLIER_ID]\n      ,[SUPPLIER_CODE_UNIQUE]\n  FROM [DIM_COMMON_SUPPLIER]\n";
            ...
            row3.SUPPLIER_ID = rs_tDBInput_3.getInt(1);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row3.SUPPLIER_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.SUPPLIER_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row3.SUPPLIER_CODE_UNIQUE = tmpContent_tDBInput_3;
                }
            } else {
                row3.SUPPLIER_CODE_UNIQUE = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.SUPPLIER_CODE_UNIQUE = row3.SUPPLIER_CODE_UNIQUE;
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
		    ...
		    String dbquery_tDBInput_4 = "SELECT  [MATERIAL_ID]\n      ,[MATERIAL_NO_UNIQUE]\n  FROM [DIM_MATERIAL_MATERIAL] \n";
            ...
            row4.MATERIAL_ID = rs_tDBInput_4.getInt(1);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row4.MATERIAL_NO_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.MATERIAL_NO_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row4.MATERIAL_NO_UNIQUE = tmpContent_tDBInput_4;
                }
            } else {
                row4.MATERIAL_NO_UNIQUE = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.MATERIAL_ID = row4.MATERIAL_ID;
				
				row4_HashRow.MATERIAL_NO_UNIQUE = row4.MATERIAL_NO_UNIQUE;
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.MANUFACTURER_CODE_UNIQUE == null) ? 0 : this.MANUFACTURER_CODE_UNIQUE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row5Struct other = (row5Struct) obj;
						...
						if (this.MANUFACTURER_CODE_UNIQUE == null) {
							if (other.MANUFACTURER_CODE_UNIQUE != null)
								return false;
						
						} else if (!this.MANUFACTURER_CODE_UNIQUE.equals(other.MANUFACTURER_CODE_UNIQUE))
	...
	public void copyDataTo(row5Struct other) {
		...
		other.MANUFACTURER_NO = this.MANUFACTURER_NO;
	            other.MANUFACTURER_CODE_UNIQUE = this.MANUFACTURER_CODE_UNIQUE;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
			            ...
			            this.MANUFACTURER_NO = dis.readInt();
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.MANUFACTURER_NO = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
		            	...
		            	dos.writeInt(this.MANUFACTURER_NO);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.MANUFACTURER_NO);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("MANUFACTURER_NO="+String.valueOf(MANUFACTURER_NO));
		sb.append(",MANUFACTURER_CODE_UNIQUE="+MANUFACTURER_CODE_UNIQUE);
	    sb.append("]");
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.MANUFACTURER_CODE_UNIQUE, other.MANUFACTURER_CODE_UNIQUE);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_2";
		...
		int tos_count_tDBInput_2 = 0;
		    ...
		    String dbquery_tDBInput_2 = "SELECT  [MANUFACTURER_NO]\n      ,[MANUFACTURER_CODE_UNIQUE]\n  FROM [DIM_COMMON_MANUFACTURER]\n";
		    ...
		    while (rs_tDBInput_2.next()) {
		        nb_line_tDBInput_2++;
							...
							if(colQtyInRs_tDBInput_2 < 1) {
								row5.MANUFACTURER_NO = 0;
							} else {
		                          
            row5.MANUFACTURER_NO = rs_tDBInput_2.getInt(1);
            if(rs_tDBInput_2.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row5.MANUFACTURER_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_2 != null) {
            	if (talendToDBList_tDBInput_2 .contains(rsmd_tDBInput_2.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.MANUFACTURER_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
            	} else {
                	row5.MANUFACTURER_CODE_UNIQUE = tmpContent_tDBInput_2;
                }
            } else {
                row5.MANUFACTURER_CODE_UNIQUE = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.MANUFACTURER_NO = row5.MANUFACTURER_NO;
				
				row5_HashRow.MANUFACTURER_CODE_UNIQUE = row5.MANUFACTURER_CODE_UNIQUE;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Main_Template.class.getClassLoader().getResourceAsStream("ods_material_manufacturer_part_no/main_template_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     299843 characters generated by Talend Open Studio for Data Integration 
 *     on the August 6, 2024 at 1:08:48 PM CST
 ************************************************************************************************/