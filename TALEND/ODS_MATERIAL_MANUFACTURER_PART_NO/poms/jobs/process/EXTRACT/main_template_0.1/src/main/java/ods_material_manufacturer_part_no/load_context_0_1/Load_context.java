...
package ods_material_manufacturer_part_no.load_context_0_1;
...
/**
 * Job: Load_context Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status PROD
 */
public class Load_context implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(jobMain != null){
					...
					this.setProperty("jobMain", jobMain.toString());
...
public String getBusinessFolder(){
	...
	private final String jobName = "Load_context";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Load_context.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
java.io.File file_tFileExist_2 = new java.io.File(context.TALEND_CONF_Directory + context.jobMain + ".properties");
...
globalMap.put("tFileExist_2_FILENAME",context.TALEND_CONF_Directory + context.jobMain + ".properties");
...
end_Hash.put("tFileExist_2", System.currentTimeMillis());
   			...
   			if (((Boolean)globalMap.get("tFileExist_2_EXISTS"))) {
					...
					if(execStat){
   	 					runStat.updateStatOnConnection("If_exists", 0, "true");
					}
				tFileInputDelimited_1Process(globalMap);
					...
					if(execStat){   
   	 					runStat.updateStatOnConnection("If_exists", 0, "false");
					}   	 
   				}
   			if (!((Boolean)globalMap.get("tFileExist_2_EXISTS"))) {
   				
					if(execStat){
   	 					runStat.updateStatOnConnection("if_not_exists", 0, "true");
					}
				tJava_2Process(globalMap);
					...
					if(execStat){   
   	 					runStat.updateStatOnConnection("if_not_exists", 0, "false");
					}   	 
   				}
...
public static class outStruct implements routines.system.IPersistableRow<outStruct> {
    final static byte[] commonByteArrayLock_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context = new byte[0];
    static byte[] commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context.length) {
				if(length < 1024 && commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context.length == 0) {
   					commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context = new byte[1024];
				} else {
   					commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_MANUFACTURER_PART_NO_Load_context) {
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
			...
			if(footer_value_tFileInputDelimited_1 >0 || random_value_tFileInputDelimited_1 > 0){
				throw new java.lang.Exception("When the input source is a stream,footer and random shouldn't be bigger than 0.");				
						...
						try {
							fid_tFileInputDelimited_1 = new org.talend.fileprocess.FileInputDelimited(((String)globalMap.get("tFileExist_2_FILENAME")), "ISO-8859-15","=","\n",true,0,0,
...
globalMap.put("tFileInputDelimited_1_ERROR_MESSAGE",e.getMessage());
				...
				int columnIndexWithD_tFileInputDelimited_1 = 0;
					...
					columnIndexWithD_tFileInputDelimited_1 = 0;
							...
							in.key = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
						
				
					columnIndexWithD_tFileInputDelimited_1 = 1;
					
							in.value = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
Var.toSkip = in.key == null || "".equals(in.key) || '#' == in.key.charAt(0) ?
	true
	: false ;// ###############################
        // ###############################
        // # Output tables
...
String[] row_tBufferOutput_1=new String[]{"","",};		
	    ...
	    if(out.value != null){
	            ...
	            row_tBufferOutput_1[1] = out.value;
 ...
 */
	...
	currentComponent="tFileInputDelimited_1";
                ...
                if(!((Object)(((String)globalMap.get("tFileExist_2_FILENAME"))) instanceof java.io.InputStream)){
...
System.out.println("The file " + ((String)globalMap.get("tFileExist_2_FILENAME")) + "  doesn't exists, the context values will be thus set in the talend job" );
 ...
 */
    ...
    public static void main(String[] args){
        final Load_context Load_contextClass = new Load_context();

        int exitCode = Load_contextClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Load_context.class.getClassLoader().getResourceAsStream("ods_material_manufacturer_part_no/load_context_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Load_context.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("jobMain", "id_String");
                        if(context.getStringValue("jobMain") == null) {
                            context.jobMain = null;
                        } else {
                            context.jobMain=(String) context.getProperty("jobMain");
                        }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("jobMain")) {
                context.jobMain = (String) parentContextMap.get("jobMain");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Load_context");
        }
...
/************************************************************************************************
 *     61954 characters generated by Talend Open Studio for Data Integration 
