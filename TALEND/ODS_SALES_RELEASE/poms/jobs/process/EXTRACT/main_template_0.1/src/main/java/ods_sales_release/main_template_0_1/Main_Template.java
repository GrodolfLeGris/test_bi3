...
package ods_sales_release.main_template_0_1;
...
public String getTALEND_CONF_FileSeparator(){
	...
	private final String projectName = "ODS_SALES_RELEASE";
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_ODS_SALES_RELEASE_Main_Template = new byte[0];
    static byte[] commonByteArray_ODS_SALES_RELEASE_Main_Template = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_SALES_RELEASE_Main_Template.length) {
				if(length < 1024 && commonByteArray_ODS_SALES_RELEASE_Main_Template.length == 0) {
   					commonByteArray_ODS_SALES_RELEASE_Main_Template = new byte[1024];
				} else {
   					commonByteArray_ODS_SALES_RELEASE_Main_Template = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_SALES_RELEASE_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_RELEASE_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_SALES_RELEASE_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_SALES_RELEASE_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_SALES_RELEASE_Main_Template) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ods_sales_release.load_context_0_1.Load_context childJob_tRunJob_1 = new ods_sales_release.load_context_0_1.Load_context();
	    // pass DataSources
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public String loopKey;
			    ...
			    public java.util.Date PRELIMINARY_DUE_DATE;

				public java.util.Date getPRELIMINARY_DUE_DATE () {
					return this.PRELIMINARY_DUE_DATE;
				}
			    ...
			    public boolean FORECAST_INCLUDE;

				public boolean getFORECAST_INCLUDE () {
					return this.FORECAST_INCLUDE;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.RELEASE_ID == null) ? 0 : this.RELEASE_ID.hashCode());
					
						result = prime * result + ((this.PO_LINE_KEY == null) ? 0 : this.PO_LINE_KEY.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						if (this.RELEASE_ID == null) {
							if (other.RELEASE_ID != null)
								return false;
						
						} else if (!this.RELEASE_ID.equals(other.RELEASE_ID))
						
							return false;
					
						if (this.PO_LINE_KEY == null) {
							if (other.PO_LINE_KEY != null)
								return false;
						
						} else if (!this.PO_LINE_KEY.equals(other.PO_LINE_KEY))
	...
	public void copyDataTo(row2Struct other) {
		...
		other.ORGANIZATIONLVL3ID = this.ORGANIZATIONLVL3ID;
	            ...
	            other.RELEASE_NO = this.RELEASE_NO;
	            other.RELEASE_ID = this.RELEASE_ID;
	            other.RELEASE_STATUS = this.RELEASE_STATUS;
	            other.PO = this.PO;
	            other.PO_LINE_KEY = this.PO_LINE_KEY;
	            other.QUANTITY = this.QUANTITY;
	            other.PRELIMINARY_DUE_DATE = this.PRELIMINARY_DUE_DATE;
	            other.SNAPSHOT_DATE = this.SNAPSHOT_DATE;
	            other.DUE_DATE = this.DUE_DATE;
	            other.RELEASE_SOURCE = this.RELEASE_SOURCE;
	            other.RELEASE_TYPE = this.RELEASE_TYPE;
	            other.FIRM = this.FIRM;
	            other.PLANNING = this.PLANNING;
	            other.FORECAST_INCLUDE = this.FORECAST_INCLUDE;
	            other.UNIT_PRICE = this.UNIT_PRICE;
	            other.UNIT_COST = this.UNIT_COST;
		...
		synchronized(commonByteArrayLock_ODS_SALES_RELEASE_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.RELEASE_NO = readString(dis);
					
						this.RELEASE_ID = readInteger(dis);
					
					this.RELEASE_STATUS = readString(dis);
					...
					this.PRELIMINARY_DUE_DATE = readDate(dis);
					
					this.SNAPSHOT_DATE = readDate(dis);
					
					this.DUE_DATE = readDate(dis);
					
					this.RELEASE_SOURCE = readString(dis);
					
					this.RELEASE_TYPE = readString(dis);
					
			        this.FIRM = dis.readBoolean();
					
			        this.PLANNING = dis.readBoolean();
					
			        this.FORECAST_INCLUDE = dis.readBoolean();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.RELEASE_NO,dos);
					...
					// String
						...
						writeString(this.RELEASE_STATUS,dos);
					...
					// java.util.Date
						...
						writeDate(this.PRELIMINARY_DUE_DATE,dos);
					...
					// String
						...
						writeString(this.RELEASE_SOURCE,dos);
					
					// String
				
						writeString(this.RELEASE_TYPE,dos);
					
					// boolean
				
		            	dos.writeBoolean(this.FIRM);
					
					// boolean
				
		            	dos.writeBoolean(this.PLANNING);
					
					// boolean
				
		            	dos.writeBoolean(this.FORECAST_INCLUDE);
    ...
    public String toString() {
		...
		sb.append(",RELEASE_NO="+RELEASE_NO);
		sb.append(",RELEASE_ID="+String.valueOf(RELEASE_ID));
		sb.append(",RELEASE_STATUS="+RELEASE_STATUS);
		sb.append(",PO="+PO);
		sb.append(",PO_LINE_KEY="+String.valueOf(PO_LINE_KEY));
		sb.append(",QUANTITY="+String.valueOf(QUANTITY));
		sb.append(",PRELIMINARY_DUE_DATE="+String.valueOf(PRELIMINARY_DUE_DATE));
		sb.append(",SNAPSHOT_DATE="+String.valueOf(SNAPSHOT_DATE));
		sb.append(",DUE_DATE="+String.valueOf(DUE_DATE));
		sb.append(",RELEASE_SOURCE="+RELEASE_SOURCE);
		sb.append(",RELEASE_TYPE="+RELEASE_TYPE);
		sb.append(",FIRM="+String.valueOf(FIRM));
		sb.append(",PLANNING="+String.valueOf(PLANNING));
		sb.append(",FORECAST_INCLUDE="+String.valueOf(FORECAST_INCLUDE));
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.RELEASE_ID, other.RELEASE_ID);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ODS_SALES_RELEASE_Main_Template = new byte[0];
			    ...
			    public String PRELIMINARY_DUE_DATE;

				public String getPRELIMINARY_DUE_DATE () {
					return this.PRELIMINARY_DUE_DATE;
				}
			    ...
			    public Integer Forecast_Include;

				public Integer getForecast_Include () {
					return this.Forecast_Include;
				}
		...
		synchronized(commonByteArrayLock_ODS_SALES_RELEASE_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.PRELIMINARY_DUE_DATE = readString(dis);
					
					this.Due_Date = readString(dis);
					...
					this.Release_Type = readString(dis);
						...
						this.Planning = readInteger(dis);
					
						this.Forecast_Include = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.PRELIMINARY_DUE_DATE,dos);
					
					// String
				
						writeString(this.Due_Date,dos);
					...
					// Integer
						...
						writeInteger(this.Planning,dos);
					
					// Integer
				
						writeInteger(this.Forecast_Include,dos);
    ...
    public String toString() {
		...
		sb.append(",PO_LINE_KEY="+String.valueOf(PO_LINE_KEY));
		sb.append(",QUANTITY="+String.valueOf(QUANTITY));
		sb.append(",PRELIMINARY_DUE_DATE="+PRELIMINARY_DUE_DATE);
		sb.append(",Due_Date="+Due_Date);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "ODS_SALES_RELEASE";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "ODS_SALES_RELEASE";
}
	int count_tDBOutput_1=0;

        java.sql.PreparedStatement pstmt_tDBOutput_1 = conn_tDBOutput_1.prepareStatement("SELECT COUNT(1) FROM [" + tableName_tDBOutput_1 + "] WHERE [ORGANIZATIONLVL3ID] = ? AND [RELEASE_ID] = ? AND [PO_LINE_KEY] = ? AND [SNAPSHOT_DATE] = ?");
        resourceMap.put("pstmt_tDBOutput_1", pstmt_tDBOutput_1);
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([ORGANIZATIONLVL3ID],[MATERIAL_ID],[RELEASE_NO],[RELEASE_ID],[RELEASE_STATUS],[PO],[PO_LINE_KEY],[QUANTITY],[PRELIMINARY_DUE_DATE],[SNAPSHOT_DATE],[DUE_DATE],[RELEASE_SOURCE],[RELEASE_TYPE],[FIRM],[PLANNING],[FORECAST_INCLUDE],[UNIT_PRICE],[UNIT_COST]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [MATERIAL_ID] = ?,[RELEASE_NO] = ?,[RELEASE_STATUS] = ?,[PO] = ?,[QUANTITY] = ?,[PRELIMINARY_DUE_DATE] = ?,[DUE_DATE] = ?,[RELEASE_SOURCE] = ?,[RELEASE_TYPE] = ?,[FIRM] = ?,[PLANNING] = ?,[FORECAST_INCLUDE] = ?,[UNIT_PRICE] = ?,[UNIT_COST] = ? WHERE [ORGANIZATIONLVL3ID] = ? AND [RELEASE_ID] = ? AND [PO_LINE_KEY] = ? AND [SNAPSHOT_DATE] = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nEXEC ('sproc278344_10639364_1837912') AT [PLEX]\n";
            ...
            if(tmpContent_tDBInput_1 != null) {
                ...
                row1.PART_NO_UNIQUE = null;
							...
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.RELEASE_NO = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(3);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.RELEASE_NO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.RELEASE_NO = tmpContent_tDBInput_1;
                }
            } else {
                row1.RELEASE_NO = null;
            }
            ...
            row1.RELEASE_ID = rs_tDBInput_1.getInt(4);
            if(rs_tDBInput_1.wasNull()){
                    row1.RELEASE_ID = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 5) {
								row1.Release_Status = null;
							} else {
	                         		
           		tmpContent_tDBInput_1 = rs_tDBInput_1.getString(5);
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Release_Status = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Release_Status = tmpContent_tDBInput_1;
                }
            } else {
                row1.Release_Status = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.PO = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.PO = tmpContent_tDBInput_1;
                }
            } else {
                row1.PO = null;
            }
            ...
            row1.PO_LINE_KEY = rs_tDBInput_1.getInt(7);
            if(rs_tDBInput_1.wasNull()){
                    row1.PO_LINE_KEY = null;
            }
		                    }
            ...
            row1.QUANTITY = rs_tDBInput_1.getDouble(8);
            if(rs_tDBInput_1.wasNull()){
                    row1.QUANTITY = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 9) {
								row1.PRELIMINARY_DUE_DATE = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(9).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.PRELIMINARY_DUE_DATE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.PRELIMINARY_DUE_DATE = tmpContent_tDBInput_1;
                }
            } else {
                row1.PRELIMINARY_DUE_DATE = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Due_Date = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Due_Date = tmpContent_tDBInput_1;
                }
            } else {
                row1.Due_Date = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(11).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.SNAPSHOT_DATE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.SNAPSHOT_DATE = tmpContent_tDBInput_1;
                }
            } else {
                row1.SNAPSHOT_DATE = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(12).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Release_Source = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Release_Source = tmpContent_tDBInput_1;
                }
            } else {
                row1.Release_Source = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(13).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Release_Type = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Release_Type = tmpContent_tDBInput_1;
                }
            } else {
                row1.Release_Type = null;
            }
            ...
            row1.Firm = rs_tDBInput_1.getInt(14);
            if(rs_tDBInput_1.wasNull()){
                    row1.Firm = null;
            }
		                    }
            ...
            row1.Planning = rs_tDBInput_1.getInt(15);
            if(rs_tDBInput_1.wasNull()){
                    row1.Planning = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 16) {
								row1.Forecast_Include = null;
							} else {
		                          
            row1.Forecast_Include = rs_tDBInput_1.getInt(16);
            if(rs_tDBInput_1.wasNull()){
                    row1.Forecast_Include = null;
            }
		                    }
            ...
            row1.Price = rs_tDBInput_1.getDouble(17);
            if(rs_tDBInput_1.wasNull()){
                    row1.Price = null;
            }
		                    }
            ...
            row1.Cost = rs_tDBInput_1.getDouble(18);
            if(rs_tDBInput_1.wasNull()){
                    row1.Cost = null;
            }
		                    }
...
Insert_tmp.RELEASE_NO = row1.RELEASE_NO ;
Insert_tmp.RELEASE_ID = row1.RELEASE_ID ;
Insert_tmp.RELEASE_STATUS = row1.Release_Status ;
Insert_tmp.PO = row1.PO ;
Insert_tmp.PO_LINE_KEY = row1.PO_LINE_KEY ;
Insert_tmp.QUANTITY = row1.QUANTITY ;
Insert_tmp.PRELIMINARY_DUE_DATE = row1.PRELIMINARY_DUE_DATE!=null && !"".equalsIgnoreCase(row1.PRELIMINARY_DUE_DATE)? 
TalendDate.parseDate("yyyy-MM-dd",row1.PRELIMINARY_DUE_DATE) :null ;
Insert_tmp.SNAPSHOT_DATE = row1.SNAPSHOT_DATE!=null && !"".equalsIgnoreCase(row1.SNAPSHOT_DATE)? 
TalendDate.parseDate("yyyy-MM-dd",row1.SNAPSHOT_DATE) :null ;
Insert_tmp.DUE_DATE = row1.Due_Date!=null && !"".equalsIgnoreCase(row1.Due_Date)? TalendDate.parseDate("yyyy-MM-dd",row1.Due_Date) :null ;
Insert_tmp.RELEASE_SOURCE = row1.Release_Source ;
Insert_tmp.RELEASE_TYPE = row1.Release_Type ;
Insert_tmp.FIRM = Mathematical.MOD(row1.Firm,2)==1 ;
Insert_tmp.PLANNING = Mathematical.MOD(row1.Planning ,2) == 1 ;
Insert_tmp.FORECAST_INCLUDE = Mathematical.MOD(row1.Forecast_Include,2)==1 ;
Insert_tmp.UNIT_PRICE = row1.Price ;
Insert_tmp.UNIT_COST = row1.Cost ;
Insert = Insert_tmp;
// ###############################
...
} else {pstmt_tDBOutput_1.setInt(2, Insert.RELEASE_ID);
}



                    if(Insert.PO_LINE_KEY == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.INTEGER);
} else {pstmt_tDBOutput_1.setInt(3, Insert.PO_LINE_KEY);
}



                    if(Insert.SNAPSHOT_DATE != null) {
pstmt_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(Insert.SNAPSHOT_DATE.getTime()));
} else {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        ...
                        if(Insert.RELEASE_NO == null) {
pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(2, Insert.RELEASE_NO);
}

                        if(Insert.RELEASE_STATUS == null) {
pstmtUpdate_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(3, Insert.RELEASE_STATUS);
}

                        if(Insert.PO == null) {
pstmtUpdate_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(4, Insert.PO);
}

                        pstmtUpdate_tDBOutput_1.setDouble(5, Insert.QUANTITY);

                        if(Insert.PRELIMINARY_DUE_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(6, new java.sql.Timestamp(Insert.PRELIMINARY_DUE_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(6, java.sql.Types.TIMESTAMP);
}

                        if(Insert.DUE_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(7, new java.sql.Timestamp(Insert.DUE_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(7, java.sql.Types.TIMESTAMP);
}

                        if(Insert.RELEASE_SOURCE == null) {
pstmtUpdate_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(8, Insert.RELEASE_SOURCE);
}

                        if(Insert.RELEASE_TYPE == null) {
pstmtUpdate_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_1.setString(9, Insert.RELEASE_TYPE);
}

                        pstmtUpdate_tDBOutput_1.setBoolean(10, Insert.FIRM);

                        pstmtUpdate_tDBOutput_1.setBoolean(11, Insert.PLANNING);

                        pstmtUpdate_tDBOutput_1.setBoolean(12, Insert.FORECAST_INCLUDE);

                        if(Insert.UNIT_PRICE == null) {
pstmtUpdate_tDBOutput_1.setNull(13, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_1.setDouble(13, Insert.UNIT_PRICE);
}

                        if(Insert.UNIT_COST == null) {
pstmtUpdate_tDBOutput_1.setNull(14, java.sql.Types.DOUBLE);
} else {pstmtUpdate_tDBOutput_1.setDouble(14, Insert.UNIT_COST);
}
                        ...
                        if(Insert.ORGANIZATIONLVL3ID == null) {
pstmtUpdate_tDBOutput_1.setNull(15 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(15 + count_tDBOutput_1, Insert.ORGANIZATIONLVL3ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setInt(16 + count_tDBOutput_1, Insert.RELEASE_ID);
}
...
pstmtUpdate_tDBOutput_1.setNull(17 + count_tDBOutput_1, java.sql.Types.INTEGER);
} else {pstmtUpdate_tDBOutput_1.setInt(17 + count_tDBOutput_1, Insert.PO_LINE_KEY);
}
                        ...
                        if(Insert.SNAPSHOT_DATE != null) {
pstmtUpdate_tDBOutput_1.setTimestamp(18 + count_tDBOutput_1, new java.sql.Timestamp(Insert.SNAPSHOT_DATE.getTime()));
} else {
pstmtUpdate_tDBOutput_1.setNull(18 + count_tDBOutput_1, java.sql.Types.TIMESTAMP);
}
...
pstmtInsert_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
                        ...
                        pstmtInsert_tDBOutput_1.setInt(2, Insert.MATERIAL_ID);

                        if(Insert.RELEASE_NO == null) {
pstmtInsert_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(3, Insert.RELEASE_NO);
}

                        if(Insert.RELEASE_ID == null) {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(4, Insert.RELEASE_ID);
}

                        if(Insert.RELEASE_STATUS == null) {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(5, Insert.RELEASE_STATUS);
}

                        if(Insert.PO == null) {
pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(6, Insert.PO);
}

                        if(Insert.PO_LINE_KEY == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(7, Insert.PO_LINE_KEY);
}

                        pstmtInsert_tDBOutput_1.setDouble(8, Insert.QUANTITY);

                        if(Insert.PRELIMINARY_DUE_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(9, new java.sql.Timestamp(Insert.PRELIMINARY_DUE_DATE.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(9, java.sql.Types.TIMESTAMP);
}

                        if(Insert.SNAPSHOT_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(10, new java.sql.Timestamp(Insert.SNAPSHOT_DATE.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(10, java.sql.Types.TIMESTAMP);
}

                        if(Insert.DUE_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(11, new java.sql.Timestamp(Insert.DUE_DATE.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_1.setString(12, Insert.RELEASE_SOURCE);
}

                        if(Insert.RELEASE_TYPE == null) {
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(13, Insert.RELEASE_TYPE);
}

                        pstmtInsert_tDBOutput_1.setBoolean(14, Insert.FIRM);

                        pstmtInsert_tDBOutput_1.setBoolean(15, Insert.PLANNING);

                        pstmtInsert_tDBOutput_1.setBoolean(16, Insert.FORECAST_INCLUDE);

                        if(Insert.UNIT_PRICE == null) {
pstmtInsert_tDBOutput_1.setNull(17, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_1.setDouble(17, Insert.UNIT_PRICE);
}

                        if(Insert.UNIT_COST == null) {
pstmtInsert_tDBOutput_1.setNull(18, java.sql.Types.DOUBLE);
} else {pstmtInsert_tDBOutput_1.setDouble(18, Insert.UNIT_COST);
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
            ...
            if(!whetherReject_tDBOutput_1) {
                            row2 = new row2Struct();
                                ...
                                row2.RELEASE_NO = Insert.RELEASE_NO;
                                row2.RELEASE_ID = Insert.RELEASE_ID;
                                row2.RELEASE_STATUS = Insert.RELEASE_STATUS;
                                row2.PO = Insert.PO;
                                row2.PO_LINE_KEY = Insert.PO_LINE_KEY;
                                row2.QUANTITY = Insert.QUANTITY;
                                row2.PRELIMINARY_DUE_DATE = Insert.PRELIMINARY_DUE_DATE;
                                row2.SNAPSHOT_DATE = Insert.SNAPSHOT_DATE;
                                row2.DUE_DATE = Insert.DUE_DATE;
                                row2.RELEASE_SOURCE = Insert.RELEASE_SOURCE;
                                row2.RELEASE_TYPE = Insert.RELEASE_TYPE;
                                row2.FIRM = Insert.FIRM;
                                row2.PLANNING = Insert.PLANNING;
                                row2.FORECAST_INCLUDE = Insert.FORECAST_INCLUDE;
                                row2.UNIT_PRICE = Insert.UNIT_PRICE;
                                row2.UNIT_COST = Insert.UNIT_COST;
            }
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Main_Template.class.getClassLoader().getResourceAsStream("ods_sales_release/main_template_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     286229 characters generated by Talend Open Studio for Data Integration 
 *     on the July 17, 2024 at 2:01:52 PM CDT
 ************************************************************************************************/