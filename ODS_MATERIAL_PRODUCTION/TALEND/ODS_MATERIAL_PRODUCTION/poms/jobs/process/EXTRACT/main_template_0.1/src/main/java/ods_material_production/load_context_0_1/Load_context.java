...
package ods_material_production.load_context_0_1;
...
public static class outStruct implements routines.system.IPersistableRow<outStruct> {
    final static byte[] commonByteArrayLock_ODS_MATERIAL_PRODUCTION_Load_context = new byte[0];
    static byte[] commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context.length) {
				if(length < 1024 && commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context.length == 0) {
   					commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context = new byte[1024];
				} else {
   					commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_PRODUCTION_Load_context, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_PRODUCTION_Load_context) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Load_context.class.getClassLoader().getResourceAsStream("ods_material_production/load_context_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     61589 characters generated by Talend Open Studio for Data Integration 
 *     on the August 26, 2024 at 1:59:51 PM CST
 ************************************************************************************************/