...
package ods_material_production.main_template_0_1;
...
public String getTALEND_CONF_FileSeparator(){
	...
	private final String projectName = "ODS_MATERIAL_PRODUCTION";
...
public static class row10Struct implements routines.system.IPersistableRow<row10Struct> {
    final static byte[] commonByteArrayLock_ODS_MATERIAL_PRODUCTION_Main_Template = new byte[0];
    static byte[] commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template.length) {
				if(length < 1024 && commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template.length == 0) {
   					commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template = new byte[1024];
				} else {
   					commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template, 0, length);
			strReturn = new String(commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_PRODUCTION_Main_Template) {
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		ods_material_production.load_context_0_1.Load_context childJob_tRunJob_1 = new ods_material_production.load_context_0_1.Load_context();
	    // pass DataSources
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    public String loopKey;
			    ...
			    public Boolean IS_LAST_OPERATION;

				public Boolean getIS_LAST_OPERATION () {
					return this.IS_LAST_OPERATION;
				}
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.SERIAL_NO == null) ? 0 : this.SERIAL_NO.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						} else if (!this.OPERATION_ID.equals(other.OPERATION_ID))
						
							return false;
					
						if (this.SERIAL_NO == null) {
							if (other.SERIAL_NO != null)
								return false;
						
						} else if (!this.SERIAL_NO.equals(other.SERIAL_NO))
	...
	public void copyDataTo(row2Struct other) {
		...
		other.ORGANIZATIONLVL3ID = this.ORGANIZATIONLVL3ID;
	            ...
	            other.INVENTORY_TYPE = this.INVENTORY_TYPE;
	            ...
	            other.IS_LAST_OPERATION = this.IS_LAST_OPERATION;
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_PRODUCTION_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
			        ...
			        this.REJECTED = dis.readBoolean();
					
						this.OPERATION_ID = readInteger(dis);
					
					this.INVENTORY_TYPE = readString(dis);
					...
					this.SERIAL_NO = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.SALE_UNIT_PRICE = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.IS_LAST_OPERATION = null;
           				} else {
           			    	this.IS_LAST_OPERATION = dis.readBoolean();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// boolean
		            	...
		            	dos.writeBoolean(this.REJECTED);
					
					// Integer
				
						writeInteger(this.OPERATION_ID,dos);
					
					// String
				
						writeString(this.INVENTORY_TYPE,dos);
					...
					// Double
						...
						if(this.SALE_UNIT_PRICE == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.SALE_UNIT_PRICE);
		            	}
					
					// Boolean
				
						if(this.IS_LAST_OPERATION == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeBoolean(this.IS_LAST_OPERATION);
		            	}
    ...
    public String toString() {
		...
		sb.append(",REJECTED="+String.valueOf(REJECTED));
		sb.append(",OPERATION_ID="+String.valueOf(OPERATION_ID));
		sb.append(",INVENTORY_TYPE="+INVENTORY_TYPE);
		...
		sb.append(",IS_LAST_OPERATION="+String.valueOf(IS_LAST_OPERATION));
	    sb.append("]");
    ...
    public int compareTo(row2Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.OPERATION_ID, other.OPERATION_ID);
						if(returnValue != 0) {
							return returnValue;
						}

					
						returnValue = checkNullsAndCompare(this.SERIAL_NO, other.SERIAL_NO);
						if(returnValue != 0) {
							return returnValue;
						}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    ...
    static byte[] commonByteArray_ODS_MATERIAL_PRODUCTION_Main_Template = new byte[0];
			    ...
			    public String OPERATION_CODE_UNIQUE;

				public String getOPERATION_CODE_UNIQUE () {
					return this.OPERATION_CODE_UNIQUE;
				}
			    ...
			    public String BUILDING_CODE_UNIQUE;

				public String getBUILDING_CODE_UNIQUE () {
					return this.BUILDING_CODE_UNIQUE;
				}
			    ...
			    public Integer IS_LAST_OPERATION;

				public Integer getIS_LAST_OPERATION () {
					return this.IS_LAST_OPERATION;
				}
        	...
        	try {
        		...
        		int length = 0;
					...
					this.REPORT_DATE = readString(dis);
						...
						this.REJECTED = readInteger(dis);
					
					this.OPERATION_CODE_UNIQUE = readString(dis);
					...
					this.ConfimationYieldQuantity = readString(dis);
						...
						this.IS_LAST_OPERATION = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.REJECTED,dos);
					
					// String
				
						writeString(this.OPERATION_CODE_UNIQUE,dos);
					...
					// String
						...
						writeString(this.BUILDING_CODE_UNIQUE,dos);
					...
					// Integer
						...
						writeInteger(this.IS_LAST_OPERATION,dos);
    ...
    public String toString() {
		...
		sb.append(",REJECTED="+String.valueOf(REJECTED));
		sb.append(",OPERATION_CODE_UNIQUE="+OPERATION_CODE_UNIQUE);
		sb.append(",INVENTORY_TYPE="+INVENTORY_TYPE);
...
if(dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
    tableName_tDBOutput_1 = "ODS_MATERIAL_PRODUCTION";
} else {
    tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "ODS_MATERIAL_PRODUCTION";
}
	int count_tDBOutput_1=0;
        ...
        String insert_tDBOutput_1 = "INSERT INTO [" + tableName_tDBOutput_1 + "] ([ORGANIZATIONLVL3ID],[MATERIAL_ID],[QUANTITY],[TRANSACTION_DATE],[REPORT_DATE],[REJECTED],[OPERATION_ID],[INVENTORY_TYPE],[LOCATION_ID],[BUILDING_ID],[SERIAL_NO],[SALE_UNIT_PRICE],[IS_LAST_OPERATION]) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
        java.sql.PreparedStatement pstmtInsert_tDBOutput_1 = conn_tDBOutput_1.prepareStatement(insert_tDBOutput_1);
        resourceMap.put("pstmtInsert_tDBOutput_1", pstmtInsert_tDBOutput_1);
        String update_tDBOutput_1 = "UPDATE [" + tableName_tDBOutput_1 + "] SET [MATERIAL_ID] = ?,[QUANTITY] = ?,[TRANSACTION_DATE] = ?,[REPORT_DATE] = ?,[REJECTED] = ?,[INVENTORY_TYPE] = ?,[LOCATION_ID] = ?,[BUILDING_ID] = ?,[SALE_UNIT_PRICE] = ?,[IS_LAST_OPERATION] = ? WHERE [ORGANIZATIONLVL3ID] = ? AND [OPERATION_ID] = ? AND [SERIAL_NO] = ?";
 ...
 */
	...
	currentComponent="tDBInput_1";
		...
		int tos_count_tDBInput_1 = 0;
		    ...
		    String dbquery_tDBInput_1 = "\nEXEC ('sproc278344_10639364_1837962') AT [PLEX]\n";
            ...
            row1.QUANTITY = rs_tDBInput_1.getDouble(3);
            if(rs_tDBInput_1.wasNull()){
                    row1.QUANTITY = null;
            }
		                    }
            ...
            row1.REJECTED = rs_tDBInput_1.getInt(6);
            if(rs_tDBInput_1.wasNull()){
                    row1.REJECTED = null;
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 7) {
								row1.OPERATION_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(7).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.OPERATION_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.OPERATION_CODE_UNIQUE = tmpContent_tDBInput_1;
                }
            } else {
                row1.OPERATION_CODE_UNIQUE = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.INVENTORY_TYPE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.INVENTORY_TYPE = tmpContent_tDBInput_1;
                }
            } else {
                row1.INVENTORY_TYPE = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
                ...
                row1.WORKCENTER_CODE_UNIQUE = null;
							...
							if(colQtyInRs_tDBInput_1 < 10) {
								row1.BUILDING_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.BUILDING_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.BUILDING_CODE_UNIQUE = tmpContent_tDBInput_1;
                }
            } else {
                row1.BUILDING_CODE_UNIQUE = null;
            }
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(11).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.Serial_No = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.Serial_No = tmpContent_tDBInput_1;
                }
            } else {
                row1.Serial_No = null;
            }
            ...
            row1.SALE_UNIT_PRICE = rs_tDBInput_1.getDouble(12);
            if(rs_tDBInput_1.wasNull()){
                    row1.SALE_UNIT_PRICE = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_1 != null) {
                ...
                row1.ConfimationYieldQuantity = null;
							...
							if(colQtyInRs_tDBInput_1 < 25) {
								row1.IS_LAST_OPERATION = null;
							} else {
		                          
            row1.IS_LAST_OPERATION = rs_tDBInput_1.getInt(25);
            if(rs_tDBInput_1.wasNull()){
                    row1.IS_LAST_OPERATION = null;
            }
		                    }
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row4HashKey.OPERATION_CODE_UNIQUE = row1.OPERATION_CODE_UNIQUE ;
				           		...
				           		if(tHash_Lookup_row4 != null && tHash_Lookup_row4.getCount(row4HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row4' and it contains more one result from keys :  row4.OPERATION_CODE_UNIQUE = '" + row4HashKey.OPERATION_CODE_UNIQUE + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.LOCATION_UNIQUE = row1.WORKCENTER_CODE_UNIQUE ;
				           		...
				           		if(tHash_Lookup_row5 != null && tHash_Lookup_row5.getCount(row5HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row5' and it contains more one result from keys :  row5.LOCATION_UNIQUE = '" + row5HashKey.LOCATION_UNIQUE + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow6 = false;
 							...
 							row6Struct row6ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row6HashKey.BUILDING_CODE_UNIQUE = row1.BUILDING_CODE_UNIQUE ;
				           		...
				           		if(tHash_Lookup_row6 != null && tHash_Lookup_row6.getCount(row6HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row6' and it contains more one result from keys :  row6.BUILDING_CODE_UNIQUE = '" + row6HashKey.BUILDING_CODE_UNIQUE + "'");
								} // G 071
...
Insert_tmp.IS_LAST_OPERATION = Mathematical.MOD(row1.IS_LAST_OPERATION,2)== 1 ;
Insert = Insert_tmp;
// ###############################
...
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
            ...
            if(checkCount_tDBOutput_1 > 0) {
                        ...
                        pstmtUpdate_tDBOutput_1.setDouble(2, Insert.QUANTITY);
...
} else {pstmtUpdate_tDBOutput_1.setDouble(9, Insert.SALE_UNIT_PRICE);
}

                        if(Insert.IS_LAST_OPERATION == null) {
pstmtUpdate_tDBOutput_1.setNull(10, java.sql.Types.BOOLEAN);
} else {pstmtUpdate_tDBOutput_1.setBoolean(10, Insert.IS_LAST_OPERATION);
}
...
} else {pstmtUpdate_tDBOutput_1.setInt(11 + count_tDBOutput_1, Insert.ORGANIZATIONLVL3ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setInt(12 + count_tDBOutput_1, Insert.OPERATION_ID);
}
...
} else {pstmtUpdate_tDBOutput_1.setString(13 + count_tDBOutput_1, Insert.SERIAL_NO);
}
...
pstmtInsert_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
                        ...
                        pstmtInsert_tDBOutput_1.setDouble(3, Insert.QUANTITY);

                        if(Insert.TRANSACTION_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(4, new java.sql.Timestamp(Insert.TRANSACTION_DATE.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(4, java.sql.Types.TIMESTAMP);
}

                        if(Insert.REPORT_DATE != null) {
pstmtInsert_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(Insert.REPORT_DATE.getTime()));
} else {
pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_1.setBoolean(6, Insert.REJECTED);

                        if(Insert.OPERATION_ID == null) {
pstmtInsert_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
} else {pstmtInsert_tDBOutput_1.setInt(7, Insert.OPERATION_ID);
}

                        if(Insert.INVENTORY_TYPE == null) {
pstmtInsert_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_1.setString(8, Insert.INVENTORY_TYPE);
}

                        pstmtInsert_tDBOutput_1.setInt(9, Insert.LOCATION_ID);

                        pstmtInsert_tDBOutput_1.setInt(10, Insert.BUILDING_ID);
...
} else {pstmtInsert_tDBOutput_1.setDouble(12, Insert.SALE_UNIT_PRICE);
}

                        if(Insert.IS_LAST_OPERATION == null) {
pstmtInsert_tDBOutput_1.setNull(13, java.sql.Types.BOOLEAN);
} else {pstmtInsert_tDBOutput_1.setBoolean(13, Insert.IS_LAST_OPERATION);
}
...
globalMap.put("tDBOutput_1_ERROR_MESSAGE",e.getMessage());
            ...
            if(!whetherReject_tDBOutput_1) {
                            row2 = new row2Struct();
                                ...
                                row2.REJECTED = Insert.REJECTED;
                                row2.OPERATION_ID = Insert.OPERATION_ID;
                                row2.INVENTORY_TYPE = Insert.INVENTORY_TYPE;
                                ...
                                row2.IS_LAST_OPERATION = Insert.IS_LAST_OPERATION;
            }
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row3,row4,row5,row6) outputs:(Insert)
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.OPERATION_CODE_UNIQUE == null) ? 0 : this.OPERATION_CODE_UNIQUE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row4Struct other = (row4Struct) obj;
						...
						if (this.OPERATION_CODE_UNIQUE == null) {
							if (other.OPERATION_CODE_UNIQUE != null)
								return false;
						
						} else if (!this.OPERATION_CODE_UNIQUE.equals(other.OPERATION_CODE_UNIQUE))
	...
	public void copyDataTo(row4Struct other) {
		...
		other.OPERATION_ID = this.OPERATION_ID;
	            other.OPERATION_CODE_UNIQUE = this.OPERATION_CODE_UNIQUE;
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.OPERATION_ID = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
		            	...
		            	dos.writeInt(this.OPERATION_ID);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.OPERATION_ID);
    ...
    public int compareTo(row4Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.OPERATION_CODE_UNIQUE, other.OPERATION_CODE_UNIQUE);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_3";
		...
		int tos_count_tDBInput_3 = 0;
		    ...
		    String dbquery_tDBInput_3 = "SELECT [OPERATION_ID]\n      ,[OPERATION_CODE_UNIQUE]\n  FROM [DIM_MATERIAL_OPERATION]\n";
            ...
            row4.OPERATION_ID = rs_tDBInput_3.getInt(1);
            if(rs_tDBInput_3.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 2) {
								row4.OPERATION_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row4.OPERATION_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row4.OPERATION_CODE_UNIQUE = tmpContent_tDBInput_3;
                }
            } else {
                row4.OPERATION_CODE_UNIQUE = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.OPERATION_ID = row4.OPERATION_ID;
				
				row4_HashRow.OPERATION_CODE_UNIQUE = row4.OPERATION_CODE_UNIQUE;
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
    ...
    public String loopKey;
			    ...
			    public String LOCATION_UNIQUE;

				public String getLOCATION_UNIQUE () {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.LOCATION_UNIQUE == null) ? 0 : this.LOCATION_UNIQUE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row5Struct other = (row5Struct) obj;
						...
						if (this.LOCATION_UNIQUE == null) {
							if (other.LOCATION_UNIQUE != null)
								return false;
						
						} else if (!this.LOCATION_UNIQUE.equals(other.LOCATION_UNIQUE))
	...
	public void copyDataTo(row5Struct other) {
		...
		other.LOCATION_ID = this.LOCATION_ID;
	            other.LOCATION_UNIQUE = this.LOCATION_UNIQUE;
		...
		synchronized(commonByteArrayLock_ODS_MATERIAL_PRODUCTION_Main_Template) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.LOCATION_UNIQUE = readString(dis);
    ...
    public void writeKeysData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.LOCATION_UNIQUE,dos);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("LOCATION_ID="+String.valueOf(LOCATION_ID));
		sb.append(",LOCATION_UNIQUE="+LOCATION_UNIQUE);
	    sb.append("]");
    ...
    public int compareTo(row5Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.LOCATION_UNIQUE, other.LOCATION_UNIQUE);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_4";
		...
		int tos_count_tDBInput_4 = 0;
		    ...
		    String dbquery_tDBInput_4 = "SELECT [LOCATION_ID]\n      ,[LOCATION_UNIQUE]\n  FROM [DIM_COMMON_LOCATION]\n";
            ...
            row5.LOCATION_ID = rs_tDBInput_4.getInt(1);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_4 < 2) {
								row5.LOCATION_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row5.LOCATION_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row5.LOCATION_UNIQUE = tmpContent_tDBInput_4;
                }
            } else {
                row5.LOCATION_UNIQUE = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.LOCATION_UNIQUE = row5.LOCATION_UNIQUE;
...
public static class row6Struct implements routines.system.IPersistableComparableLookupRow<row6Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.BUILDING_CODE_UNIQUE == null) ? 0 : this.BUILDING_CODE_UNIQUE.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row6Struct other = (row6Struct) obj;
						...
						if (this.BUILDING_CODE_UNIQUE == null) {
							if (other.BUILDING_CODE_UNIQUE != null)
								return false;
						
						} else if (!this.BUILDING_CODE_UNIQUE.equals(other.BUILDING_CODE_UNIQUE))
	...
	public void copyDataTo(row6Struct other) {
		...
		other.BUILDING_ID = this.BUILDING_ID;
	            other.BUILDING_CODE_UNIQUE = this.BUILDING_CODE_UNIQUE;
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
			            ...
			            this.BUILDING_ID = objectIn.readInt();
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
					...
					objectOut.writeInt(this.BUILDING_ID);
    ...
    public int compareTo(row6Struct other) {
		...
		int returnValue = -1;
						...
						returnValue = checkNullsAndCompare(this.BUILDING_CODE_UNIQUE, other.BUILDING_CODE_UNIQUE);
						if(returnValue != 0) {
							return returnValue;
						}
 ...
 */
	...
	currentComponent="tDBInput_5";
		...
		int tos_count_tDBInput_5 = 0;
		    ...
		    String dbquery_tDBInput_5 = "SELECT  [BUILDING_ID]\n      ,[BUILDING_CODE_UNIQUE]\n  FROM [DIM_COMMON_BUILDING]\n";
            ...
            row6.BUILDING_ID = rs_tDBInput_5.getInt(1);
            if(rs_tDBInput_5.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_5 < 2) {
								row6.BUILDING_CODE_UNIQUE = null;
							} else {
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row6.BUILDING_CODE_UNIQUE = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row6.BUILDING_CODE_UNIQUE = tmpContent_tDBInput_5;
                }
            } else {
                row6.BUILDING_CODE_UNIQUE = null;
            }
 ...
 */
	...
	currentComponent="tAdvancedHash_row6";
				...
				row6_HashRow.BUILDING_ID = row6.BUILDING_ID;
				
				row6_HashRow.BUILDING_CODE_UNIQUE = row6.BUILDING_CODE_UNIQUE;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Main_Template.class.getClassLoader().getResourceAsStream("ods_material_production/main_template_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     350341 characters generated by Talend Open Studio for Data Integration 
 *     on the August 26, 2024 at 1:59:52 PM CST
 ************************************************************************************************/